...
.awsui_root_vdkpj_rej1i_181:not(#\9) {
...
.awsui_item-wrapper_vdkpj_rej1i_217:not(#\9) {
  display: inline-block;
}

.awsui_group_vdkpj_rej1i_221:not(#\9) {
  display: contents;
}

.awsui_divider_vdkpj_rej1i_225:not(#\9) {
  background-color: var(--color-border-divider-default-g2zqci, #eaeded);
  inline-size: var(--border-divider-section-width-4f9905, 1px);
  margin-block: var(--space-static-xs-zgeph4, 8px);
}