...
const styles_selectors_js_2 = require("../../../internal/components/chart-legend/styles.selectors.js");
...
class CommonChartWrapper extends dom_1.ComponentWrapper {
    findDefaultFilter() {
        return this.findComponent(`.${styles_selectors_js_1.default['chart-filter']}`, chart_filter_1.default);
    }
    findStatusContainer() {
        return this.findByClassName(styles_selectors_js_4.default.root);
    }
    findLegend() {
        return this.findComponent(`.${styles_selectors_js_2.default.root}`, chart_legend_1.default);
    }
    findDetailPopover() {
