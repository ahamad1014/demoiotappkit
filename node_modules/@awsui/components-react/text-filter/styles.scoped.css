...
.awsui_root_1sdq3_bb92t_145:not(#\9) {
  ...
  display: flex;
  align-items: center;
  max-inline-size: calc(688px - 2 * var(--space-l-f4l5gr, 20px));
}

.awsui_input_1sdq3_bb92t_180:not(#\9) {
  flex: 1;
}

.awsui_results_1sdq3_bb92t_184:not(#\9) {
