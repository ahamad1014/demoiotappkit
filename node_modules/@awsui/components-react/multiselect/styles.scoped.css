...
.awsui_root_f8g6q_dcktm_145:not(#\9) {
...
.awsui_embedded_f8g6q_dcktm_177:not(#\9) {
  border-collapse: separate;
  border-spacing: 0;
  box-sizing: border-box;
  caption-side: top;
...
.awsui_tokens_f8g6q_dcktm_210:not(#\9) {
  margin-block-start: var(--space-scaled-xs-wbfgrv, 8px);
}