...
.awsui_key-value-pairs_1y9fy_1etyh_145:not(#\9) {
...
.awsui_group-title_1y9fy_1etyh_177:not(#\9) {
  padding-block-end: var(--space-scaled-m-gxhdpl, 16px);
}

.awsui_group-list_1y9fy_1etyh_181:not(#\9) {
...
.awsui_group-list-item_1y9fy_1etyh_191:not(#\9) {
  /* used in test-utils */
}

.awsui_term_1y9fy_1etyh_195:not(#\9) {
  font-size: var(--font-size-body-m-kbh530, 14px);
  line-height: var(--line-height-body-m-0awzkk, 22px);
  font-weight: var(--font-display-label-weight-q56x6f, 400);
  color: var(--color-text-label-du7fzg, #545b64);
  margin-block-end: var(--space-key-value-gap-wtha4n, 2px);
}

.awsui_key-label_1y9fy_1etyh_203:not(#\9) {
  margin-inline-end: var(--space-xs-edba2s, 8px);
}
.awsui_key-label_1y9fy_1etyh_203:not(#\9):only-child {
  margin-block: 0;
  margin-inline: 0;
}

.awsui_detail_1y9fy_1etyh_211:not(#\9) {
  border-collapse: separate;
  border-spacing: 0;
  box-sizing: border-box;
  caption-side: top;
...
.awsui_info_1y9fy_1etyh_246:not(#\9) {
  display: inline-flex;
