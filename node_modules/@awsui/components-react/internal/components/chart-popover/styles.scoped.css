...
.awsui_root_1t44z_tqqik_145:not(#\9) {
...
.awsui_hover-area_1t44z_tqqik_178:not(#\9) {
  pointer-events: none;
  padding-block: var(--space-static-s-q0yjjb, 12px);
  padding-inline: var(--space-static-s-q0yjjb, 12px);
  margin-block: calc(-1 * var(--space-static-s-q0yjjb, 12px));
  margin-inline: calc(-1 * var(--space-static-s-q0yjjb, 12px));
}

.awsui_popover-body_1t44z_tqqik_186:not(#\9) {
  pointer-events: auto;
}