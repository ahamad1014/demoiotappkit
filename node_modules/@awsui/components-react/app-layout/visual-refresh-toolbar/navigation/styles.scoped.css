...
/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
.awsui_navigation-container_2p2ab_3oyl4_153:not(#\9) {
  position: sticky;
  z-index: 830;
...
.awsui_navigation-container_2p2ab_3oyl4_153:not(#\9):not(.awsui_is-navigation-open_2p2ab_3oyl4_164) {
  inline-size: 0px;
  display: none;
}
.awsui_navigation-container_2p2ab_3oyl4_153 > .awsui_navigation_2p2ab_3oyl4_153:not(#\9) {
  flex-grow: 1;
  block-size: 100%;
  overflow-y: auto;
...
.awsui_hide-navigation_2p2ab_3oyl4_184:not(#\9) {
  position: absolute;
  inset-inline-end: var(--space-m-h2th94, 16px);
