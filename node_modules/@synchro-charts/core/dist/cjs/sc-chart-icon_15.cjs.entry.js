...
const _commonjsHelpers = require('./_commonjsHelpers-ac2d0785.js');
const common = require('./common-9c0591ff.js');
const constants$1$1 = require('./constants-11a37182.js');
const EmptyStatus = require('./EmptyStatus-f1df041d.js');
...
const ascendingBisect = utils.bisector(utils.ascending);
const bisectRight = ascendingBisect.right;
const bisectCenter = utils.bisector(number).center;
...
const icons = {
    normal(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", fill: color ? `${color}` : '#1d8102' },
            index.h("path", { d: "M8 0C3.6 0 0 3.6 0 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm0 14c-3.3 0-6-2.7-6-6s2.7-6 6-6 6 2.7 6 6-2.7 6-6 6z" }),
            index.h("path", { d: "M7 8.6l-2-2L3.6 8 7 11.4l4.9-4.9-1.4-1.4z" })));
    },
    active(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, fill: color ? `${color}` : '#d13212', viewBox: "0 0 16 16" },
            index.h("g", { fill: "none", "fill-rule": "evenodd" },
                index.h("circle", { cx: "8", cy: "8", r: "7", stroke: color ? `${color}` : '#d13212', "stroke-width": "2" }),
                index.h("g", { transform: "translate(7 4)" },
                    index.h("mask", { id: "b", fill: "#fff" },
                        index.h("path", { id: "a", d: "M2.00129021 6v2h-2V6h2zm0-6v5h-2V0h2z" })),
                    index.h("g", { mask: "url(#b)" },
                        index.h("path", { fill: color ? `${color}` : '#d13212', d: "M-7-5H9v16H-7z" }))))));
    },
    acknowledged(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", stroke: color ? `${color}` : '#3184c2' },
            index.h("path", { fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M2 12.286h5.143L8.857 14l1.714-1.714H14V2H2v10.286z" }),
            index.h("path", { fill: "none", "stroke-linecap": "round", "stroke-width": "2", "stroke-miterlimit": "10", d: "M4.99 7H5v.01h-.01zM7.99 7H8v.01h-.01zM10.99 7H11v.01h-.01z" })));
    },
    disabled(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", stroke: color ? `${color}` : '#687078' },
            index.h("g", { fill: "none", "stroke-width": "2" },
                index.h("circle", { cx: "8", cy: "8", r: "7", "stroke-linejoin": "round" }),
                index.h("path", { "stroke-linecap": "square", "stroke-miterlimit": "10", d: "M11 8H5" }))));
    },
    latched(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", fill: color ? `${color}` : '#f89256' },
            index.h("path", { d: "M15.9 14.6l-7-14c-.3-.7-1.5-.7-1.8 0l-7 14c-.2.3-.1.7 0 1 .2.2.6.4.9.4h14c.3 0 .7-.2.9-.5.1-.3.1-.6 0-.9zM2.6 14L8 3.2 13.4 14H2.6z" }),
            index.h("path", { d: "M7 11v2h2v-2zM7 6h2v4H7z" })));
    },
    snoozed(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", stroke: color ? `${color}` : '#879596' },
            index.h("g", { fill: "none", "stroke-width": "2" },
                index.h("circle", { cx: "8", cy: "8", r: "7", "stroke-linejoin": "round" }),
                index.h("path", { "stroke-linecap": "square", "stroke-miterlimit": "10", d: "M8 5v4H5" }))));
    },
    error(color, size = DEFAULT_SIZE_PX) {
        return (index.h("svg", { width: `${size}px`, height: `${size}px`, viewBox: "0 0 16 16", fill: color ? `${color}` : '#FF0000', "data-test-tag": "error" },
            index.h("path", { class: "st4", d: "M13.7 2.3C12.1.8 10.1 0 8 0S3.9.8 2.3 2.3C.8 3.9 0 5.9 0 8s.8 4.1 2.3 5.7C3.9 15.2 5.9 16 8 16s4.1-.8 5.7-2.3C15.2 12.1 16 10.1 16 8s-.8-4.1-2.3-5.7zm-1.5 9.9C11.1 13.4 9.6 14 8 14s-3.1-.6-4.2-1.8S2 9.6 2 8s.6-3.1 1.8-4.2S6.4 2 8 2s3.1.6 4.2 1.8S14 6.4 14 8s-.6 3.1-1.8 4.2z" }),
            index.h("path", { class: "st4", d: "M10.1 4.5L8 6.6 5.9 4.5 4.5 5.9 6.6 8l-2.1 2.1 1.4 1.4L8 9.4l2.1 2.1 1.4-1.4L9.4 8l2.1-2.1z" })));
    },
};
...
const ScChartIcon = class {
    constructor(hostRef) {
        ...
        this.name = constants$1.StatusIcon.NORMAL;
    }
    render() {
        return index.h("div", { class: "sc-chart-icon" }, getIcons(this.name, this.color, this.size));
    }
};
...
const ScDataStreamName = class {
    ...
    render() {
        return (index.h("div", { class: "awsui" }, index.h("sc-expandable-input", { isDisabled: !this.isEditing, onValueChange: (value) => {
                this.onNameChange(value);
            }, onMouseOver: this.renderTooltip, onFocus: this.renderTooltip, value: this.label }), index.h("div", { class: "data-stream-name-tooltip awsui-util-container awsui", style: { display: 'none' } }, index.h("div", { class: "awsui-util-spacing-v-s" }, index.h("div", null, index.h("div", { class: "awsui-util-label" }, this.detailedLabel || this.label), this.pointType && this.pointType === "trend" /* TREND */ && (index.h("small", null, "This trend line is computed from only visible data."))), this.date && (index.h("div", null, index.h("div", { class: "awsui-util-label" }, "Latest value at"), index.h("div", null, this.date.toLocaleString('en-US', {
            hour12: true,
            minute: 'numeric',
            hour: 'numeric',
            year: 'numeric',
...
const scErrorBadgeCss = "sc-error-badge div{display:-ms-flexbox;display:flex;padding-left:1.4286em;line-height:1.4286em;color:var(--error-badge-font-color, #6a7070)}sc-error-badge .warning-symbol{font-size:2rem;padding-right:var(--margin-small);font-weight:bold;color:var(--error-badge-warning-color, #fa3232)}";
...
const ScErrorBadge = class {
    ...
    render() {
        return (index.h("div", { "data-test-tag": "error" }, index.h("span", { class: "warning-symbol" }, "\u26A0"), index.h("slot", null)));
    }
};
...
const ScExpandableInput = class {
    ...
    render() {
        ...
        return (index.h("span", { "data-test-tag": "expandable-input", contentEditable: !isDisabled, class: `sc-expandable-input aws-util-font-size-1 ${isDisabled ? 'disabled' : ''}`,
...
function ticker(year, month, week, day, hour, minute) {
  ...
  function tickInterval(start, stop, count) {
    ...
    const i = utils.bisector(([,, step]) => step).right(tickIntervals, target);
...
const ScGestureHandler = class {
    ...
    render() {
        const { width, height } = this.size;
        return (index.h("svg", null, this.start != null && this.end != null && index.h("line", { x1: this.start, y1: 0, x2: this.start, y2: height }), this.start != null && this.end != null && (index.h("rect", { class: "brush-box", x: Math.min(this.start, this.end), height: height, width: Math.abs(this.end - this.start), y: 0 })), this.start != null && this.end != null && index.h("line", { x1: this.end, y1: 0, x2: this.end, y2: height }), index.h("rect", { class: "overlay zoom-container", width: width, height: height })));
    }
    get el() { return index.getElement(this); }
...
const computeTrendResult = (dataStream, trendType) => {
    switch (trendType) {
        case dataConstants.TREND_TYPE.LINEAR:
...
const getAllTrendResults = (viewport, dataStreams, trends) => {
    ...
    dataStreams.forEach(stream => {
        const { id } = stream;
        const dataPoints = getDataPoints.getDataPoints(stream, stream.resolution);
        ...
        const dataInViewport = dataFilters.getVisibleData(dataPoints, viewport);
...
const scLegendCss = "sc-legend .legend-container{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;font-size:var(--font-size-1);overflow-y:scroll;overflow-x:hidden;-ms-overflow-style:none;scrollbar-width:none}sc-legend .legend-container::-webkit-scrollbar{display:none}";
...
const ScLegend = class {
    constructor(hostRef) {
        ...
        this.visualizedDataStreams = () => {
            const streams = this.dataStreams.filter(predicates.isSupportedDataType(this.supportString));
            ...
            return streams.filter(({ streamType }) => streamType !== dataConstants.StreamType.ALARM);
        };
        /**
         * Returns the given color of a breached threshold, if there is one.
         */
        this.breachedThresholdColor = (point, dataStream) => {
            const threshold = breachedThreshold.breachedThreshold({
                value: point && point.y,
    ...
    render() {
        const points = breachedThreshold.activePoints({
            viewport: this.viewport,
            dataStreams: this.dataStreams,
            selectedDate: this.viewport.end,
            allowMultipleDates: true,
            dataAlignment: constants$1.DATA_ALIGNMENT.EITHER,
        });
        const lastDate = points.length === 0 || points[0].point == null ? this.viewport.end.getTime() : points[0].point.x;
        return (index.h("div", { class: "legend-container", style: { flexDirection: this.config.position === constants$1.LEGEND_POSITION.RIGHT ? 'column' : 'unset' } }, this.visualizedDataStreams().map(dataStream => {
...
const ScLegendRow = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "legend-row-container awsui" }, this.showDataStreamColor && (index.h("div", { class: "color-container" }, this.isLoading ? (index.h("div", { class: "spinner-container" }, index.h("sc-loading-spinner", { dark: true, size: 12 }))) : (index.h("svg", { class: "bar", "data-testid": `legend-icon-${this.pointType}` }, index.h("path", { stroke: this.color, "stroke-dasharray": isTrendPoint ? dataTypes.TREND_ICON_DASH_ARRAY : '', "stroke-linecap": dataTypes.STREAM_ICON_STROKE_LINECAP, "stroke-width": dataTypes.STREAM_ICON_STROKE_WIDTH, d: dataTypes.STREAM_ICON_PATH_COMMAND }))))), index.h("div", { class: "info" }, index.h("sc-data-stream-name", { onNameChange: this.updateName, isEditing: this.isEditing, label: this.label, detailedLabel: this.detailedLabel, pointType: this.pointType, date: this.point && new Date(this.point.x) }), index.h("div", { class: "legend-value", style: this.isEditing ? EDIT_MODE_STYLE : VIEW_MODE_STYLE }, this.icon && index.h("sc-chart-icon", { name: this.icon }), index.h("h4", { class: "awsui-util-d-i", "data-testid": "current-value", style: { color: this.valueColor } }, index.h(Value.Value, { value: this.point ? this.point.y : undefined })), this.unit && index.h("small", null, "\u00A0", this.unit))))));
    }
};
ScLegendRow.style = scLegendRowCss;

const scLoadingSpinnerCss = "@-webkit-keyframes fadeIn{from{opacity:0}to{opacity:1}}@keyframes fadeIn{from{opacity:0}to{opacity:1}}@-webkit-keyframes spin{from{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes spin{from{-webkit-transform:rotate(0);transform:rotate(0)}to{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}svg{-webkit-animation:spin 900ms linear infinite, fadeIn 1s linear;animation:spin 900ms linear infinite, fadeIn 1s linear}path#c{fill:var(--loading-spinner-color)}.dark path#c{fill:var(--loading-spinner-color-dark)}";
...
const ScLoadingSpinner = class {
    ...
    render() {
        ...
        return (index.h("svg", { class: { dark }, style: size != null ? { width: `${size}px`, height: `${size}px` } : {}, "data-testid": "loading", viewBox: "0 0 200 200" }, index.h("defs", null, index.h("clipPath", { id: "a" }, index.h("path", { d: "M200 100a100 100 0 11-2.19-20.79l-9.78 2.08A90 90 0 10190 100z" })), index.h("filter", { id: "b", x: "0", y: "0" }, index.h("feGaussianBlur", { in: "SourceGraphic", stdDeviation: "3" })), index.h("path", { id: "c", d: "M250 100a150 150 0 01-3.28 31.19L100 100z" })), index.h("g", { "clip-path": "url(#a)" }, index.h("g", { filter: "url(#b)", transform: "rotate(-6 100 100)" }, index.h("use", { xlinkHref: "#c", "fill-opacity": "0" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".03", transform: "rotate(12 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".07", transform: "rotate(24 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".1", transform: "rotate(36 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".14", transform: "rotate(48 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".17", transform: "rotate(60 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".2", transform: "rotate(72 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".24", transform: "rotate(84 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".28", transform: "rotate(96 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".31", transform: "rotate(108 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".34", transform: "rotate(120 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".38", transform: "rotate(132 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".41", transform: "rotate(144 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".45", transform: "rotate(156 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".48", transform: "rotate(168 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".52", transform: "rotate(180 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".55", transform: "rotate(192 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".59", transform: "rotate(204 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".62", transform: "rotate(216 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".66", transform: "rotate(228 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".69", transform: "rotate(240 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".7", transform: "rotate(252 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".72", transform: "rotate(264 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".76", transform: "rotate(276 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".79", transform: "rotate(288 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".83", transform: "rotate(300 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".86", transform: "rotate(312 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".93", transform: "rotate(324 100 100)" }), index.h("use", { xlinkHref: "#c", "fill-opacity": ".97", transform: "rotate(336 100 100)" }), index.h("use", { xlinkHref: "#c", transform: "rotate(348 100 100)" })))));
    }
};
...
const ScSizeProvider = class {
    constructor(hostRef) {
        ...
        this.setRect = () => {
            if (this.el && this.el.isConnected) {
                const newRect = webglContext.rectScrollFixed(this.el);
                ...
                if (rectHasUpdated) {
                    if (this.rect && this.rect.density !== newRect.density) {
                        ...
                        webglContext.webGLRenderer.onResolutionChange();
                    }
    ...
    componentWillLoad() {
         ...
         */
        this.resizer = new webglContext.index(entries => {
    ...
    render() {
        ...
        return index.h("div", { class: "sc-size-provider-container" }, renderChild(this.renderFunc, rect));
    }
    get el() { return index.getElement(this); }
};
...
const ScTooltip = class {
    ...
    render() {
        ...
        return (index.h("sc-tooltip-rows", { trendResults: this.trendResults, size: this.size, dataStreams: this.dataStreams, viewport: this.viewport, selectedDate: this.selectedDate, thresholds: this.thresholds, maxDurationFromDate: this.maxDurationFromDate, showDataStreamColor: this.showDataStreamColor, dataAlignment: this.dataAlignment, supportString: this.supportString, visualizesAlarms: this.visualizesAlarms, showBlankTooltipRows: this.showBlankTooltipRows, sortPoints: this.sortPoints, top: this.top }));
    }
};
...
const ScTooltipRow = class {
    ...
    render() {
        ...
        return (index.h("div", { class: "clearfix" }, this.showDataStreamColor && (index.h("span", { class: "awsui-util-mr-xs" }, index.h("svg", { class: "bar", "data-testid": `tooltip-icon-${this.pointType}` }, index.h("path", { stroke: this.color, "stroke-dasharray": isTrendPoint ? dataTypes.TREND_ICON_DASH_ARRAY : undefined, "stroke-linecap": dataTypes.STREAM_ICON_STROKE_LINECAP, "stroke-width": dataTypes.STREAM_ICON_STROKE_WIDTH, d: dataTypes.STREAM_ICON_PATH_COMMAND })))), index.h("span", { class: "label awsui-util-d-i", "data-testid": "tooltip-row-label" }, this.label), index.h("span", { class: "value awsui-util-d-i", "data-testid": "current-value", style: { color: this.valueColor } }, this.icon && index.h("sc-chart-icon", { name: this.icon }), index.h(Value.Value, { value: this.point && this.point.y })), this.resolution != null && (index.h("div", { class: "awsui-util-pb-s" }, index.h("small", null, helper.getAggregationFrequency(this.resolution, AGGREGATED_LEVEL))))));
    }
};
...
const tooltipPosition = ({ viewport, size: { width, height }, points, resolution, selectedTimestamp, }) => {
    ...
    const modelY = Math.max(...points.map(({ point }) => (point ? point.y : undefined)).filter(predicates.isNumber));
...
const ScTooltipRows = class {
    constructor(hostRef) {
        ...
        this.getTooltipPoints = () => {
            const resolutions = this.dataStreams.map(({ resolution }) => resolution);
            const minResolution = resolutions.length > 0 ? Math.min(...resolutions) : 0;
            const dataPoints = breachedThreshold.activePoints({
                viewport: this.viewport,
            ...
            const points = this.sortPoints
                ? tooltipPoints.sort(breachedThreshold.sortTooltipPoints(p => p.y))
                : this.dataStreams.map(({ id }) => tooltipPoints.find(p => p.streamId === id)).filter(predicates.isDefined);
    ...
    render() {
        ...
        return (index.h("div", { class: "awsui" }, index.h("div", { class: "tooltip-line", style: {
                left: `${position.x}px`,
                height: `${this.size.height}px`,
            } }), index.h("div", { class: "tooltip-container", style: Object.assign({ top: tooltipContainerTop }, toolTipPositioning) }, index.h("div", { class: "awsui-util-shadow awsui-util-p-s" }, index.h("small", { class: { 'awsui-util-d-b': true, 'left-offset': !this.showDataStreamColor } }, time$1.displayDate(displayedDate, minResolution, this.viewport)), !isCrossResolution && (index.h("small", { class: { 'awsui-util-d-b': true, 'awsui-util-mb-s': true, 'left-offset': !this.showDataStreamColor } }, helper.getAggregationFrequency(minResolution, AGGREGATED_LEVEL$1))), points.map(tooltipPoint => {
            ...
            return (index.h("sc-tooltip-row", { key: `${tooltipPoint.streamId}-${tooltipPoint.type}`, showDataStreamColor: this.showDataStreamColor, label: tooltipPoint.label || dataStream.name, resolution: isCrossResolution ? dataStream.resolution : undefined, color: tooltipPoint.color || dataStream.color || 'black', point: tooltipPoint.point, pointType: tooltipPoint.type, valueColor: valueColor, icon: icon }));
        })))));
    }
};

const scWebglAxisCss = "sc-webgl-axis{font-size:var(--font-size-0)}sc-webgl-axis .axis{font-family:var(--primary-font-family);shape-rendering:crispEdges;position:absolute;overflow:hidden;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;pointer-events:none}sc-webgl-axis .axis path{display:none}sc-webgl-axis .axis .tick{color:var(--polaris-light-gray)}sc-webgl-axis line.x-axis-separator{color:var(--primary-light);stroke:var(--primary-light);stroke-width:1px}sc-webgl-axis .axis .tick line{color:var(--primary-light)}sc-webgl-axis .axis .tick text{font-size:var(--font-size-0);-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}sc-webgl-axis .x-axis .tick:last-child text{font-weight:var(--font-weight-bold)}";
...
const ScWebglAxis = class {
    ...
    render() {
        ...
        return (index.h("svg", { class: "axis", style: {
...
const LoadingStatus = ({ isLoading }) => (index.h("div", { style: {
        zIndex: '11',
        position: 'absolute',
        width: '100%',
        height: '100%',
        ...
        alignItems: 'center',
        pointerEvents: 'none',
    } }, isLoading && index.h("sc-loading-spinner", { size: LOADING_SPINNER_SIZE_PX })));

const ErrorStatus = ({ hasError, size: { marginLeft, width } }) => {
    return hasError ? (index.h("div", { style: { position: 'absolute', width: `${width}px` } },
        index.h("div", { class: "awsui-util-mt-s", style: {
                left: `${marginLeft}px`,
                position: 'relative',
                width: '100%',
                display: 'flex',
            ...
            index.h("sc-error-badge", null, "Stopped")))) : (index.h("div", { "data-test-tag": "error-badge-place-holder", style: { display: 'none' } }));
};
...
const TEXT_SELECTOR = 'text.x-text';
const ANNOTATION_GROUP_SELECTOR = 'g.x-annotation';
const LINE_SELECTOR = 'line.x-line';
const renderXAnnotations = ({ container, xAnnotations, viewport, resolution, size: { width, height }, }) => {
    ...
    annotationGroup
        ...
        .attr('y1', 0)
        .attr('y2', height)
        .style('stroke', utils.getColor)
        .style('stroke-width', ANNOTATION_STROKE_WIDTH);
    /** Create X Text */
    annotationGroup
        .append('text')
        .text(annotation => utils.getValueAndText({ annotation, resolution, viewport }))
        .attr('display', utils.getValueAndTextVisibility)
        .attr('font-size', ANNOTATION_FONT_SIZE)
        .attr('class', 'x-text')
...
const TEXT_SELECTOR$1 = 'text.y-text';
const TEXT_VALUE_SELECTOR = 'text.y-value-text';
const ANNOTATION_GROUP_SELECTOR$1 = 'g.y-annotation';
const ANNOTATION_GROUP_SELECTOR_EDITABLE = 'g.y-annotation-editable';
const LINE_SELECTOR$1 = 'line.y-line';
...
const renderYAnnotationsEditable = ({ container, yAnnotations, viewport, resolution, size: { width, height }, }) => {
    ...
    const getYHandleWidth = (yAnnotation) => utils.getValueTextVisibility(yAnnotation) === 'inline' ? HANDLE_WIDTH : SMALL_HANDLE_WIDTH;
    const getDraggableLineTwoX = (yAnnotation) => utils.getValueTextVisibility(yAnnotation) === 'inline'
        ? width + DRAGGABLE_LINE_OFFSET_X + DRAGGABLE_LINE_SEPARATION
        : width + SMALL_DRAGGABLE_LINE_OFFSET_X + DRAGGABLE_LINE_SEPARATION;
    const getDraggableLineOneX = (yAnnotation) => utils.getValueTextVisibility(yAnnotation) === 'inline'
    ...
    handleGroup
        .append('text')
        .attr('display', utils.getValueTextVisibility)
        .attr('class', 'y-value-text')
        .attr('x', width + Y_ANNOTATION_TEXT_LEFT_PADDING)
        .attr('text-anchor', 'start')
        .attr('y', Y_ANNOTATION_TEXT_PADDING)
        .text(annotation => utils.getValueText({ annotation, resolution, viewport, formatText: true }))
    ...
    handleGroup
        .append('text')
        .attr('display', utils.getLabelTextVisibility)
        .attr('class', 'y-text')
...
const getTickCount = ({ width, height }, { yScaleType }) => {
    ...
    const yTickCount = Math.max(Math.floor(height / (Y_TICK_DISTANCE_PX + (yScaleType === constants$1.ScaleType.Log ? 60 : 0))), MIN_TICK_COUNT);
...
const tickCount = (size) => getTickCount({ width: size.width, height: size.height }, {
    xScaleSide: 'bottom',
    yScaleSide: 'left',
    yScaleType: constants$1.ScaleType.Linear,
    xScaleType: constants$1.ScaleType.Linear,
});
/**
 *
 * Axis Construction
...
const UnsupportedDataTypeStatus = ({ supportedDataTypes, messageOverrides, size, }) => {
    ...
    return (index.h("div", { id: "unsupported-data-type-error", class: "unsupported-data-type-status", style: {
            width: `${width + marginLeft + marginRight}px`,
            height: `${height + marginBottom + marginTop}px`,
            padding: '24px',
            background: 'white',
        ...
        index.h("h2", null, messageOverrides.unsupportedDataTypeHeader || 'Unable to render your data'),
        index.h("h2", null, messageOverrides.unsupportedDataTypeSubHeader || 'This chart only supports the following DataType(s):'),
        index.h("div", null, messageOverrides.supportedTypes || supportedDataTypes.map(type => index.h("div", null, type)))));
};
...
const attachDraggable = () => {
    ...
    const internalUpdate = constants$1$1.lodash_throttle(([onUpdate, viewport]) => {
    ...
    const draggable = ({ container, size, onUpdate, activeViewPort, emitUpdatedWidgetConfiguration, startStopDragging, dragHandle, resolution, }) => {
        ...
        dragHandle.call(drag()
            ...
            select(container)
                .selectAll(`${ANNOTATION_GROUP_SELECTOR_EDITABLE},${ANNOTATION_GROUP_SELECTOR$1}`)
                .select(TEXT_VALUE_SELECTOR)
                .text(annotation => utils.getValueText({ annotation: annotation, resolution, viewport, formatText: true }));
...
const ScWebglBaseChart = class {
    constructor(hostRef) {
        ...
        this.isEditing = false;
        this.renderLegend = props => index.h("sc-legend", Object.assign({}, props));
        this.annotations = {};
        this.trends = [];
        this.displaysError = true;
        this.supportedDataTypes = Object.values(dataConstants.DataType);
        ...
        this.start = predicates.isMinimalStaticViewport(this.viewport)
            ? new Date(this.viewport.start)
            : new Date(Date.now() - time$1.parseDuration(this.viewport.duration));
        this.end = predicates.isMinimalStaticViewport(this.viewport) ? new Date(this.viewport.end) : new Date();
        this.trendResults = [];
        ...
        this.onDateRangeChange = constants$1$1.lodash_throttle(([start, end, from]) => {
            this.dateRangeChange.emit([start, end, from]);
        }, constants$1$1.DATE_RANGE_EMIT_EVENT_MS, {
            leading: true,
            trailing: true,
        });
        this.chartSizeConfig = () => {
            ...
            const isRightLegend = this.legend && this.legend.position === constants$1.LEGEND_POSITION.RIGHT;
            const isBottomLegend = this.legend && this.legend.position === constants$1.LEGEND_POSITION.BOTTOM;
        ...
        this.activeViewPort = () => ({
            ...
            duration: !predicates.isMinimalStaticViewport(this.viewport) ? time$1.parseDuration(this.viewport.duration) : undefined,
        });
        this.handleCameraEvent = ({ start, end }) => {
            if (this.scene) {
                ...
                // Update Camera
                webglContext.webGLRenderer.updateViewPorts({ start, end, manager: this.scene });
            }
        };
        /**
        ...
        this.updateYRange = () => {
            ...
            const inViewPoints = this.dataStreams
                .filter(predicates.isNumberDataStream)
                .map(stream => dataFilters.getVisibleData(getDataPoints.getDataPoints(stream, stream.resolution), { start: this.start, end: this.end }, false))
                .flat();
            ...
            const { yMin, yMax } = getYRange({
                points: inViewPoints,
                yAnnotations: yAnnotations.filter(annotation => number$4.isNumeric(annotation.value)),
        ...
        this.getHasSupportedData = () => {
            return this.dataStreams.every(({ streamType, dataType }) => streamType === dataConstants.StreamType.ALARM || this.supportedDataTypes.includes(dataType));
        };
        this.thresholds = () => this.internalAnnotations && this.internalAnnotations.y ? this.internalAnnotations.y.filter(utils.isThreshold) : [];
        this.getThresholdOptions = () => {
            ...
            if (this.internalAnnotations == null || this.internalAnnotations.thresholdOptions == null) {
                return chartDefaults.DEFAULT_THRESHOLD_OPTIONS;
            }
            ...
            if (typeof thresholdOptions === 'boolean') {
                return thresholdOptions ? chartDefaults.DEFAULT_THRESHOLD_OPTIONS : chartDefaults.DEFAULT_THRESHOLD_OPTIONS_OFF;
            }
            // If its a threshold object, then we just use the user's setting and override it with the default settings
            // that we have
            return Object.assign(Object.assign({}, chartDefaults.DEFAULT_THRESHOLD_OPTIONS), thresholdOptions);
        };
        /**
         * Lifecycle method
         *
        ...
        this.onUpdate = ({ start, end, shouldBlockDateRangeChangedEvent, }, hasDataChanged = false, hasSizeChanged = false, hasAnnotationChanged = false, shouldRerender = false) => {
         ...
         but still being called via the view port manager. removing from the view port manager.`);
                ...
                webglContext.webGLRenderer.removeChartScene(this.scene.id);
                this.scene = null;
                return;
            }
            if (!this.scene) {
            ...
            if (!this.supportString) {
                const numberAnnotations = utils.getNumberAnnotations(this.internalAnnotations);
                renderAnnotations({
             ...
             */
            if (!this.supportString) {
                const dataStreamsWithTrends = this.visualizedDataStreams().filter(predicates.isNumberDataStream);
        ...
        this.setChartRenderingPosition = () => {
            if (this.scene) {
                ...
                webglContext.webGLRenderer.setChartRect(this.scene.id, {
        ...
        this.chartSize = () => {
            const marginLeft = this.size.marginLeft == null ? chartDefaults.DEFAULT_CHART_CONFIG.size.marginLeft : this.size.marginLeft;
            const marginRight = this.size.marginRight == null ? chartDefaults.DEFAULT_CHART_CONFIG.size.marginRight : this.size.marginRight;
            const marginTop = this.size.marginTop == null ? chartDefaults.DEFAULT_CHART_CONFIG.size.marginTop : this.size.marginTop;
            const marginBottom = this.size.marginBottom == null ? chartDefaults.DEFAULT_CHART_CONFIG.size.marginBottom : this.size.marginBottom;
    ...
    visualizedDataStreams() {
        ...
        return this.dataStreams.filter(({ streamType }) => streamType !== dataConstants.StreamType.ALARM);
    }
    onViewPortChange(newViewPort, oldViewPort) {
        if (this.scene && !lodash_isequal(newViewPort, oldViewPort)) {
            ...
            /** Update active viewport */
            this.start = predicates.isMinimalStaticViewport(newViewPort)
                ? new Date(newViewPort.start)
                : new Date(Date.now() - time$1.parseDuration(newViewPort.duration));
            this.end = predicates.isMinimalStaticViewport(newViewPort) ? new Date(newViewPort.end) : new Date();
            /**
            ...
            webglContext.webGLRenderer.updateViewPorts({
                start: this.start,
                end: this.end,
                manager: this.scene,
        ...
        if (this.scene != null && duration != null) {
            webglContext.webGLRenderer.stopTick({ manager: this.scene });
            webglContext.webGLRenderer.startTick({ manager: this.scene, duration, chartSize: this.chartSizeConfig() });
        }
    }
    ...
    setupChartScene() {
        ...
        const { duration } = this.activeViewPort();
        webglContext.webGLRenderer.addChartScene({ manager: this.scene, duration, chartSize: this.chartSizeConfig() });
        this.setChartRenderingPosition();
        webglContext.webGLRenderer.render(this.scene);
    ...
    render() {
        ...
        const hasNoDataPresent = this.visualizedDataStreams().every(stream => {
            const points = getDataPoints.getDataPoints(stream, stream.resolution);
            if (points.length === 0) {
                return true;
            }
        ...
        if (!this.getHasSupportedData()) {
            return (index.h("div", { class: "awsui sc-webgl-base-chart" }, index.h(UnsupportedDataTypeStatus, { size: chartSizeConfig, messageOverrides: this.messageOverrides || {}, supportedDataTypes: this.supportedDataTypes })));
        }
        return [
            index.h("div", { class: "awsui sc-webgl-base-chart" }, this.displaysError && index.h(ErrorStatus, { hasError: hasError, size: chartSizeConfig }), index.h("sc-webgl-axis", { size: chartSizeConfig }), index.h(DataContainer, { size: chartSizeConfig }, index.h(EmptyStatus.EmptyStatus, { displaysNoDataPresentMsg: this.displaysNoDataPresentMsg != null ? this.displaysNoDataPresentMsg : true, messageOverrides: this.messageOverrides || {}, isLoading: shouldDisplayAsLoading, hasNoDataPresent: hasNoDataPresent, hasNoDataStreamsPresent: hasNoDataStreamsPresent }), index.h(LoadingStatus, { isLoading: shouldDisplayAsLoading }), this.gestures && (index.h("sc-gesture-handler", { onDateRangeChange: this.handleCameraEvent, size: chartSizeConfig, viewport: this.activeViewPort() }))), this.legend && (index.h(ChartLegendContainer, { config: this.legend, legendHeight: LEGEND_HEIGHT, size: chartSizeConfig }, this.renderLegendComponent({ isLoading: shouldDisplayAsLoading, thresholds, showDataStreamColor })))),
            this.isMounted && this.renderTooltipComponent(marginLeft, marginTop, thresholds),
            index.h("svg", { class: "threshold-container", width: chartSizeConfig.width + marginRight, height: chartSizeConfig.height + marginBottom, style: { marginLeft: `${marginLeft}px`, marginTop: `${marginTop}px` } }),
            index.h("svg", { class: "trend-container", width: chartSizeConfig.width, height: chartSizeConfig.height, style: { marginLeft: `${marginLeft}px`, marginTop: `${marginTop}px` } }),
        ];
    }
    get el() { return index.getElement(this); }
    static get watchers() { return {
...
const ScWebglContext = class {
    ...
    componentDidLoad() {
        ...
        webglContext.webGLRenderer.initRendering(canvas, this.onContextInitialization, this.viewFrame);
    }
    render() {
        ...
        return index.h("canvas", { class: classes });
    }
    get el() { return index.getElement(this); }
};
ScWebglContext.style = scWebglContextCss;

exports.sc_chart_icon = ScChartIcon;
exports.sc_data_stream_name = ScDataStreamName;
exports.sc_error_badge = ScErrorBadge;
exports.sc_expandable_input = ScExpandableInput;
exports.sc_gesture_handler = ScGestureHandler;
exports.sc_legend = ScLegend;
exports.sc_legend_row = ScLegendRow;
exports.sc_loading_spinner = ScLoadingSpinner;
exports.sc_size_provider = ScSizeProvider;
exports.sc_tooltip = ScTooltip;
exports.sc_tooltip_row = ScTooltipRow;
exports.sc_tooltip_rows = ScTooltipRows;
exports.sc_webgl_axis = ScWebglAxis;
exports.sc_webgl_base_chart = ScWebglBaseChart;
exports.sc_webgl_context = ScWebglContext;
