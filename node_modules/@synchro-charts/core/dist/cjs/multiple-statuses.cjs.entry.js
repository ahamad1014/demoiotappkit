...
const MultipleStatuses = class {
    ...
    componentDidLoad() {
        ...
        const scene = chartScene.chartScene({
            alarms: { expires: time.HOUR_IN_MS * 5 },
            viewport: {
                start: X_MIN,
                end: X_MAX,
                yMin: 0,
            ...
            dataStreams: [
                {
                    id: 'test-stream',
                    aggregates: {
                        [time.HOUR_IN_MS * 5]: [TEST_DATA_POINT_1],
                    },
                    data: [],
                    resolution: time.HOUR_IN_MS * 5,
                ...
                },
                {
                    id: 'test-stream-2',
                    aggregates: {
                        [time.HOUR_IN_MS * 5]: [TEST_DATA_POINT_2],
                    },
                    data: [],
...
exports.multiple_statuses = MultipleStatuses;
