...
const isChartScene = predicates.isValid((v) => v.camera != null);
/**
 * Render Scene Info
 *
...
const createWebGLRenderer = (viewportHandler) => {
    ...
    const initRendering = (renderCanvas, onContextInitialization = () => { }, viewFrameRef) => {
        ...
        canvas = renderCanvas;
        renderer = new three_module.WebGLRenderer({ canvas, alpha: true, antialias: true, preserveDrawingBuffer: true });
...
exports.index = index;
exports.rectScrollFixed = rectScrollFixed;
