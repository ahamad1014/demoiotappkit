...
const routes = require('./routes-832064eb.js');
const domUtils = require('./dom-utils-ecb26edf.js');
const activeRouter = require('./active-router-fdc47105.js');
...
const App = class {
    ...
    render() {
        return (index.h("stencil-router", null, index.h("stencil-route-switch", { scrollTopOffset: 0 }, routes.routes.map(r => (index.h("stencil-route", { url: r.url, component: r.component, exact: true }))))));
    }
};
