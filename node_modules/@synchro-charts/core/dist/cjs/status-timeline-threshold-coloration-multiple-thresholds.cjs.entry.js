...
const StatusTimelineThresholdMultipleThresholds = class {
    constructor(hostRef) {
        ...
        return (index.h("div", null, index.h("sc-status-timeline", { alarms: { expires: time.MINUTE_IN_MS }, dataStreams: [
                {
                    ...
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.MINUTE_IN_MS]: [constants$1.TEST_DATA_POINT_STANDARD] },
                    data: [],
...
exports.status_timeline_threshold_coloration_multiple_thresholds = StatusTimelineThresholdMultipleThresholds;
