...
const ScWebglChartThresholdColorationMultipleThresholds = class {
    ...
    render() {
        return (index.h("div", null, index.h("sc-scatter-chart", { widgetId: "widget-id", dataStreams: [
                {
                    id: 'test',
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.MONTH_IN_MS]: [TEST_DATA_POINT, TEST_DATA_POINT_2, TEST_DATA_POINT_3] },
                    data: [],
                ...
                },
                {
                    ...
                    color: 'red',
                    name: 'test stream2',
                    aggregates: { [time.MONTH_IN_MS]: [TEST_2_DATA_POINT, TEST_2_DATA_POINT_2] },
                    data: [],
                    resolution: time.MONTH_IN_MS,
                    dataType: dataConstants.DataType.NUMBER,
                },
...
exports.sc_scatter_chart_threshold_coloration_multiple_thresholds = ScWebglChartThresholdColorationMultipleThresholds;
