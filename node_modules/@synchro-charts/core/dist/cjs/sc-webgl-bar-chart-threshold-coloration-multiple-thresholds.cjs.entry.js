        ...
        return (index.h("div", null, index.h("sc-bar-chart", { dataStreams: [
                {
                    ...
                    name: 'test stream',
                    aggregates: {
                        [time.MINUTE_IN_MS]: [constants$1.TEST_DATA_POINT_STANDARD],
                    },
                    data: [],
...
exports.sc_webgl_bar_chart_threshold_coloration_multiple_thresholds = ScWebglBarChartThresholdMultipleThresholds;
