...
var immutabilityHelper = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const update = _commonjsHelpers.unwrapExports(immutabilityHelper);

const getAggregationFrequency = (dataResolution, aggregatedLevel) => {
    if (dataResolution === 0) {
        return 'raw data';
    }
    const { day, hour, minute, seconds } = time.convertMS(dataResolution);
...
exports.getAggregationFrequency = getAggregationFrequency;
