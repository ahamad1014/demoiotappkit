...
const ScWebglChartTooltipWithMultipleDataStreams = class {
    ...
    render() {
        return (index.h("div", null, index.h("sc-line-chart", { dataStreams: [
                {
                    id: 'test',
                    color: 'black',
                    name: 'test stream',
...
exports.sc_webgl_chart_tooltip_with_multiple_data_streams = ScWebglChartTooltipWithMultipleDataStreams;
