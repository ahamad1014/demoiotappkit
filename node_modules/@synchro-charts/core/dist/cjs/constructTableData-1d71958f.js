...
const cell = (thresholds, date, dataStreams, dataStreamId) => {
    ...
    const points = stream ? getDataPoints.getDataPoints(stream, stream.resolution) : [];
...
exports.constructTableData = constructTableData;
exports.formatLiveModeOnlyMessage = formatLiveModeOnlyMessage;
