...
const ScScatterChartTrendLineWithLegend = class {
    ...
    render() {
        return (index.h("div", null, index.h("sc-line-chart", { widgetId: "widget-id", dataStreams: [
                {
                    id: 'test',
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.SECOND_IN_MS]: TEST_DATA_POINTS },
                    data: [],
                    resolution: time.SECOND_IN_MS,
                ...
                position: constants.LEGEND_POSITION.BOTTOM,
                width: 300,
            }, trends: [
                {
                    dataStreamId: 'test',
...
exports.sc_scatter_chart_trend_line_with_legend = ScScatterChartTrendLineWithLegend;
