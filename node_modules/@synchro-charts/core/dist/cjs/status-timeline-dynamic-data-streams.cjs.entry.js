...
const StatusTimelineDynamicDataStreams = class {
    constructor(hostRef) {
        ...
        this.addStream = () => {
            ...
            this.dataStreams = [
                ...this.dataStreams,
                {
                    ...
                    color: this.getColor(),
                    name: `${streamId}-name`,
                    aggregates: { [time.MONTH_IN_MS]: [leftPoint, middlePoint, rightPoint] },
                    data: [],
...
exports.status_timeline_dynamic_data_streams = StatusTimelineDynamicDataStreams;
