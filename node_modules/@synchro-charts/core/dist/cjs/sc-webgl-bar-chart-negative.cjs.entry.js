...
const ScWebglBarChartNegative = class {
    ...
    render() {
        return (index.h("div", { id: "chart-container", style: { width: '500px', height: '500px' } }, index.h("sc-bar-chart", { dataStreams: [
                {
                    id: 'test',
                    color: 'black',
                    name: 'test stream',
                    aggregates: {
                        [time.MINUTE_IN_MS]: [TEST_DATA_POINT],
                    },
                    data: [],
...
exports.sc_webgl_bar_chart_negative = ScWebglBarChartNegative;
