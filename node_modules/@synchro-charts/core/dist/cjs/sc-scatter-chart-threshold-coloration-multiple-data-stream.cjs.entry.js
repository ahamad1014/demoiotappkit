        ...
        return (index.h("div", null, index.h("sc-scatter-chart", { widgetId: "widget-id", dataStreams: [
                {
                    ...
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.MONTH_IN_MS]: [TEST_DATA_POINT, TEST_DATA_POINT_2] },
                    data: [],
...
exports.sc_scatter_chart_threshold_coloration_multiple_data_stream = ScScatterChartThresholdColorationMultipleDataStream;
