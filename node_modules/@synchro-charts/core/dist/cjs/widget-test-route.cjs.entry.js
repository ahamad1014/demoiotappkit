...
const speedingAlarmInfo = {
    dataType: dataConstants.DataType.STRING,
    resolution: 0,
    id: 'speeding-alarm',
    color: 'red',
    name: 'speeding alarm',
    streamType: dataConstants.StreamType.ALARM,
};
...
const dataStreamInfoWithAlarms = {
    ...
    name: 'mph',
    associatedStreams: [
        { id: speedingAlarmInfo.id, type: dataConstants.StreamType.ALARM },
        { id: oilChangeAlarmInfo.id, type: dataConstants.StreamType.ALARM },
    ],
};
const mphStream = {
    ...
    associatedStreams: [
        {
            ...
            type: dataConstants.StreamType.ALARM,
        },
        {
            id: speedingAlarmInfo.id,
            type: dataConstants.StreamType.ALARM,
...
const LEGEND = {
    position: constants.LEGEND_POSITION.RIGHT,
    width: 200,
    legendLabels: {
...
const WidgetTestRoute = class {
    ...
    render() {
        const viewport = Object.assign(Object.assign({}, VIEWPORT), { start: viewportStart, end: viewportEnd, duration, group: 'some-viewport-group' });
        // live mode
        if (duration != null) {
            delete viewport.start;
            delete viewport.end;
        }
        return (index.h("div", { style: { width: styleSize(width), height: styleSize(height) } }, index.h(this.component, { widgetId: "some-widget-id", dataStreams: dataStreams, isEditing: isEditing, alarms: alarms, viewport: viewport, legend: legend, size: getSize(width), axis: axis, tableColumns: tableColumns, annotations: annotations, gestures: gestures, messageOverrides: messageOverrides,
            /** TODO: Port these over to the message overrides */
            invalidTagErrorHeader: "invalidComponentTag.header", invalidTagErrorSubheader: "invalidComponentTag.subheader", liveModeOnly: "invalidWidgetForHistoricalData.content" }), index.h("sc-webgl-context", null)));
    }
};

exports.widget_test_route = WidgetTestRoute;
