...
const StatusTimelineThresholdMultipleDataStream = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    }
    render() {
        return (index.h("div", null, index.h("sc-status-timeline", { alarms: { expires: time.YEAR_IN_MS }, dataStreams: [
                {
                    id: 'test',
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.YEAR_IN_MS]: [TEST_DATA_POINT, TEST_DATA_POINT_2] },
                    data: [],
                ...
                },
                {
                    ...
                    color: 'black',
                    name: 'test stream',
                    aggregates: { [time.YEAR_IN_MS]: [TEST_2_DATA_POINT, TEST_2_DATA_POINT_2] },
                    data: [],
                    resolution: time.YEAR_IN_MS,
                    dataType: dataConstants.DataType.NUMBER,
                },
...
exports.status_timeline_threshold_coloration_multiple_data_stream = StatusTimelineThresholdMultipleDataStream;
