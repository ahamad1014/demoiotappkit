...
export declare const DATA_TYPE_ERROR_CONTAINER_SELECTOR = "sc-webgl-base-chart .unsupported-data-type-status";
...
export declare const NO_VALUE_PRESENT_SELECTOR = "[data-testid=\"no-value-present\"]";
export declare const waitForChart: (cy: any) => any;
export declare const waitForDataError: (cy: any) => any;
