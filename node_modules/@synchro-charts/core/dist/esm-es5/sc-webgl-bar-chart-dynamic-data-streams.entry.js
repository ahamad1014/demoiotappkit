...
var ScWebglBarChartDynamicDataStreams = /** @class */ (function () {
    function ScWebglBarChartDynamicDataStreams(hostRef) {
        var _this = this;
            ...
            _this.dataStreams = __spreadArrays(_this.dataStreams, [
                {
                    ...
                    name: streamId + "-name",
                    aggregates: (_a = {},
                        _a[MONTH_IN_MS] = [leftPoint, middlePoint, rightPoint],
                        _a),
                    data: [],
    ...
    return ScWebglBarChartDynamicDataStreams;
}());
