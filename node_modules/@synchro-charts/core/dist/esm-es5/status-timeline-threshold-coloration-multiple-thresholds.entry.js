...
import { T as TEST_DATA_POINT_STANDARD, b as Y_MIN, c as Y_MAX, X as X_MIN, d as X_MAX } from './constants-9d36da8a.js';
var StatusTimelineThresholdMultipleThresholds = /** @class */ (function () {
    function StatusTimelineThresholdMultipleThresholds(hostRef) {
        registerInstance(this, hostRef);
    }
    StatusTimelineThresholdMultipleThresholds.prototype.render = function () {
        var _a;
        return (h("div", null, h("sc-status-timeline", { alarms: { expires: MINUTE_IN_MS }, dataStreams: [
                {
                    ...
                    color: 'black',
                    name: 'test stream',
                    aggregates: (_a = {}, _a[MINUTE_IN_MS] = [TEST_DATA_POINT_STANDARD], _a),
                    data: [],
    ...
    return StatusTimelineThresholdMultipleThresholds;
}());
export { StatusTimelineThresholdMultipleThresholds as status_timeline_threshold_coloration_multiple_thresholds };
