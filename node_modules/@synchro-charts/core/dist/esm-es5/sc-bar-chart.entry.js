...
import { u as updateChartScene, c as chartScene } from './chartScene-028556fc.js';
...
var ScBarChart = /** @class */ (function () {
    function ScBarChart(hostRef) {
    ...
    ScBarChart.prototype.componentWillRender = function () {
        validate(this);
    };
    ScBarChart.prototype.render = function () {
        var _this = this;
        return (h("sc-size-provider", { size: this.size, renderFunc: function (size) { return (h("sc-webgl-base-chart", { supportedDataTypes: [DataType.NUMBER], axis: _this.axis, gestures: _this.gestures, configId: _this.widgetId, legend: _this.legend, annotations: _this.annotations, trends: _this.trends, updateChartScene: updateChartScene, createChartScene: chartScene, size: Object.assign(Object.assign(Object.assign({}, DEFAULT_CHART_CONFIG.size), _this.size), size), dataStreams: _this.dataStreams, alarms: _this.alarms, viewport: _this.viewport, minBufferSize: _this.minBufferSize, bufferFactor: _this.bufferFactor, isEditing: _this.isEditing, yRangeStartFromZero: true, renderTooltip: tooltip, supportString: false, visualizesAlarms: false, messageOverrides: _this.messageOverrides })); } }));
    };
    return ScBarChart;
}());
