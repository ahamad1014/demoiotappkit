...
import { c as chartScene, H as HEIGHT } from './chartScene-1c4c48c4.js';
...
var SingleColoredStatus = /** @class */ (function () {
    function SingleColoredStatus(hostRef) {
        registerInstance(this, hostRef);
    }
    SingleColoredStatus.prototype.componentDidLoad = function () {
        var _a;
            ...
            dataStreams: [
                {
                    ...
                    color: 'red',
                    aggregates: (_a = {},
                        _a[DAY_IN_MS] = [TEST_DATA_POINT_1],
                        _a),
                    data: [],
    ...
    SingleColoredStatus.prototype.render = function () {
        return (h("sc-webgl-context", null, h("div", { id: "test-container", style: { width: CHART_SIZE.width + "px", height: CHART_SIZE.height + "px" } })));
    };
    Object.defineProperty(SingleColoredStatus.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    return SingleColoredStatus;
}());
