...
var ScWebglBarChartThresholdNoColoration = /** @class */ (function () {
    function ScWebglBarChartThresholdNoColoration(hostRef) {
        registerInstance(this, hostRef);
    }
    ScWebglBarChartThresholdNoColoration.prototype.render = function () {
        var _a;
        return (h("div", null, h("sc-bar-chart", { dataStreams: [
                {
                    ...
                    data: [],
                    aggregates: (_a = {},
                        _a[MINUTE_IN_MS] = [TEST_DATA_POINT_STANDARD],
                        _a),
    ...
    return ScWebglBarChartThresholdNoColoration;
}());
