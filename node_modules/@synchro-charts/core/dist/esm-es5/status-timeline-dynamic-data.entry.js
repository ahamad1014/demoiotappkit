...
var StatusTimelineDynamicData = /** @class */ (function () {
    function StatusTimelineDynamicData(hostRef) {
        var _this = this;
        ...
        this.addDataPoint = function () {
            var dataPoint = {
                x: new Date(2000, _this.monthIndex).getTime(),
                y: 3000,
            };
    ...
    StatusTimelineDynamicData.prototype.render = function () {
        var _a;
        return (h("div", { class: "synchro-chart-tests" }, h("button", { id: "add-data-point", onClick: this.addDataPoint }, "Add Data Point"), h("button", { id: "remove-data-point", onClick: this.removeDataPoint }, "Remove Data Point"), h("br", null), h("br", null), h("div", { id: "chart-container", style: { height: '500px', width: '500px' } }, h("sc-status-timeline", { alarms: { expires: MONTH_IN_MS }, dataStreams: [
                {
                    ...
                    name: 'test stream',
                    color: 'red',
                    aggregates: (_a = {}, _a[MONTH_IN_MS] = this.data, _a),
                    data: [],
    ...
    return StatusTimelineDynamicData;
}());
