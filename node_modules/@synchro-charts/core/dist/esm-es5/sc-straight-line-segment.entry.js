...
var ScStraightLineSegment = /** @class */ (function () {
    function ScStraightLineSegment(hostRef) {
        registerInstance(this, hostRef);
    }
    ScStraightLineSegment.prototype.componentDidLoad = function () {
    ...
    ScStraightLineSegment.prototype.render = function () {
        return (h("sc-webgl-context", null, h("div", { id: "test-container", style: { width: CHART_SIZE.width + "px", height: CHART_SIZE.height + "px" } })));
    };
    Object.defineProperty(ScStraightLineSegment.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    return ScStraightLineSegment;
}());
