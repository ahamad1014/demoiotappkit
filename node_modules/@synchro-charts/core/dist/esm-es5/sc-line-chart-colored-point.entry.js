...
var ScLineChartColoredPoint = /** @class */ (function () {
    function ScLineChartColoredPoint(hostRef) {
        registerInstance(this, hostRef);
    }
    ScLineChartColoredPoint.prototype.componentDidLoad = function () {
    ...
    ScLineChartColoredPoint.prototype.render = function () {
        return (h("sc-webgl-context", null, h("div", { id: "test-container", style: { width: CHART_SIZE.width + "px", height: CHART_SIZE.height + "px" } })));
    };
    Object.defineProperty(ScLineChartColoredPoint.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    return ScLineChartColoredPoint;
}());
