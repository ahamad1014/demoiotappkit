...
var ScCirclePointShaders = /** @class */ (function () {
    function ScCirclePointShaders(hostRef) {
        registerInstance(this, hostRef);
    }
    ScCirclePointShaders.prototype.componentDidLoad = function () {
    ...
    ScCirclePointShaders.prototype.render = function () {
        return (h("sc-webgl-context", null, h("div", { id: "test-container", style: { width: CHART_SIZE.width + "px", height: CHART_SIZE.height + "px" } })));
    };
    Object.defineProperty(ScCirclePointShaders.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    return ScCirclePointShaders;
}());
