...
var NO_VALUE_PRESENT = '-';
/**
 * default messages, can be overridden via `MessageOverrides` API.
 */
/* default 'no data streams' empty state messaging */
var NO_DATA_STREAMS_PRESENT_HEADER = 'No properties or alarms';
var NO_DATA_STREAMS_PRESENT_SUB_HEADER = "This widget doesn't have any properties or alarms.";
/* default 'no data' empty state messaging */
var NO_DATA_PRESENT_HEADER = 'No data';
var NO_DATA_PRESENT_SUB_HEADER = "There's no data to display for this time range.";
