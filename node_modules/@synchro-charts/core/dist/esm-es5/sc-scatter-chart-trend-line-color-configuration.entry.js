...
// viewport boundaries
var X_MIN = new Date(2018, 0, 0);
var X_MAX = new Date(2020, 0, 0);
var Y_MIN = 0;
var Y_MAX = 5000;
// test data point dead center of the viewport
var TEST_DATA_POINTS = [
    {
...
var ScScatterChartTrendLineColorConfiguration = /** @class */ (function () {
    function ScScatterChartTrendLineColorConfiguration(hostRef) {
        registerInstance(this, hostRef);
    }
    ScScatterChartTrendLineColorConfiguration.prototype.render = function () {
        var _a;
        return (h("div", null, h("sc-line-chart", { widgetId: "widget-id", dataStreams: [
                {
                    ...
                    color: 'red',
                    name: 'test stream',
                    aggregates: (_a = {}, _a[SECOND_IN_MS] = TEST_DATA_POINTS, _a),
                    data: [],
    ...
    return ScScatterChartTrendLineColorConfiguration;
}());
