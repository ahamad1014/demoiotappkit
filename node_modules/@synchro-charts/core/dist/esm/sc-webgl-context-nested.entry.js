...
const ScWebglContextNested = class {
    ...
    render() {
        ...
        const toolbar = (h("div", { style: { height: TOOLBAR_HEIGHT_PX, width: FULL_WIDTH_PX, borderBottom: '1px solid black' } }, h("label", { htmlFor: "context" }, "Select context placement:"), h("select", { id: "context", name: "context", ref: el => {
                this.selectList = el;
            }, onChange: () => {
                var _a;
