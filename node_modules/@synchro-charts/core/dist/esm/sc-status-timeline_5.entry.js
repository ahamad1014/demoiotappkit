...
const ScStatusTimeline = class {
    ...
    render() {
        return (h("sc-size-provider", { size: this.size, renderFunc: (size) => {
                ...
                return [
                    h("div", { class: "status-timeline", style: { height: `${chartSize.height}px` } }, h("sc-webgl-base-chart", { axis: Object.assign(Object.assign({}, this.axis), { showY: false }), gestures: this.gestures, configId: this.widgetId, annotations: Object.assign(Object.assign({}, this.annotations), { show: false, thresholdOptions: {
                                showColor: true,
                            } }), supportedDataTypes: [DataType.NUMBER, DataType.STRING, DataType.BOOLEAN], updateChartScene: updateChartScene, createChartScene: chartScene, size: chartSize, dataStreams: this.dataStreams, alarms: this.alarms, viewport: this.componentViewport, minBufferSize: this.minBufferSize, bufferFactor: this.bufferFactor, isEditing: this.isEditing, renderTooltip: tooltip(this.alarms), displaysError: false, supportString: true, visualizesAlarms: true, displaysNoDataPresentMsg: false, messageOverrides: this.messageOverrides }), h("sc-status-timeline-overlay", { isEditing: this.isEditing, thresholds: this.thresholds(), date: isMinimalStaticViewport(this.viewport) ? new Date(this.viewport.end) : new Date(), dataStreams: this.dataStreams, size: chartSize, widgetId: this.widgetId })),
