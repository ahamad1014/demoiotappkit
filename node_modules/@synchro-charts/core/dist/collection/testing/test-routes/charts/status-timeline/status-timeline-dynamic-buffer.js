...
export class StatusTimelineDynamicBuffer {
    ...
    render() {
        return (h("div", { class: "synchro-chart-tests" },
            ...
            h("div", { id: "chart-container", style: { height: '500px', width: '500px', marginTop: '20px' } },
                h("sc-status-timeline", { widgetId: "widget-id", alarms: { expires: MONTH_IN_MS }, dataStreams: [
                        {
                            id: 'test',
                            color: 'red',
                            name: 'test stream',
                    ...
                    }, bufferFactor: 1, minBufferSize: 1 }),
                h("sc-webgl-context", null))));
    }
    static get is() { return "status-timeline-dynamic-buffer"; }
