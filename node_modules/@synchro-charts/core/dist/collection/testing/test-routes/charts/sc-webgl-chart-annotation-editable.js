...
export class ScWebglChartAnnotationRescaling {
    ...
    render() {
        return (h("div", { class: "synchro-chart-tests", style: { width: '1000px', height: '1000px' } },
            h("div", null,
                h("button", { id: "change-editable", onClick: this.onEditableChange }, "Change Editable")),
            h("div", null,
                h("button", { id: "change-showvalue", onClick: this.onShowValueChange }, "Change Show Value")),
            h("div", null,
    ...
    static get is() { return "sc-webgl-chart-annotation-editable"; }
