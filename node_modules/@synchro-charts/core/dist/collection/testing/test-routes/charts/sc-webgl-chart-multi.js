...
export class ScWebglChartMulti {
    render() {
        return (h("div", { id: "chart-container", style: { border: '1px solid lightgray', height: '500px', width: '500px' } },
            h("sc-line-chart", { widgetId: "widget-a", dataStreams: [
                    {
                        id: 'test',
                        color: 'black',
                        name: 'test stream',
            ...
            h("sc-line-chart", { widgetId: "widget-b", dataStreams: [
                    {
                        id: 'test',
                        color: 'black',
                        name: 'test stream',
    ...
    static get is() { return "sc-webgl-chart-multi"; }
}
