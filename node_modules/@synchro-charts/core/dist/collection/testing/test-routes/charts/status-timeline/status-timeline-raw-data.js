...
export class StatusTimelineRawData {
    render() {
        return (h("div", null,
            h("sc-status-timeline", { alarms: { expires: MINUTE_IN_MS }, dataStreams: [
                    {
                        id: 'test',
                        data: DATA_POINTS,
                        color: 'black',
                    ...
                    width: 500,
                    height: 500,
                }, annotations: annotations, viewport: { yMin: Y_MIN, yMax: Y_MAX, start: X_MIN, end: X_MAX } }),
            h("sc-webgl-context", null)));
    }
    static get is() { return "status-timeline-raw-data"; }
}
