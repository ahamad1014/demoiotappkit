...
export class StatusTimelineDynamicDataStreams {
    ...
    render() {
        return (h("div", { class: "synchro-chart-tests" },
            h("button", { id: "add-stream", onClick: this.addStream }, "Add Stream"),
            h("button", { id: "remove-stream", onClick: this.removeStream }, "Remove Stream"),
            h("br", null),
            h("br", null),
            h("div", { id: "chart-container", style: { marginTop: '20px', width: '500px', height: '500px' } },
                h("sc-status-timeline", { alarms: { expires: MONTH_IN_MS }, dataStreams: this.dataStreams, size: {
                        width: 500,
                        height: 500,
    ...
    static get is() { return "status-timeline-dynamic-data-streams"; }
