 ...
 */
export const constructSearchQuery = ({ latestValue = undefined, threshold = undefined, showIcon = false, isEnabled = true, numDataStreams = 1, showValue = true, showName = true, showUnit = true, isEditing = false, }) => `threshold=${threshold}&showIcon=${showIcon}&isEnabled=${isEnabled}&latestValue=${String(latestValue)}&numDataStreams=${numDataStreams}&showValue=${showValue}&showUnit=${showUnit}&showName=${showName}&isEditing=${isEditing}`;
