...
export class ScWebglContextNested {
    ...
    render() {
        ...
        const selectOption = (o) => (h("option", { value: o, selected: o === this.contextPlacement }, o));
        const toolbar = (h("div", { style: { height: TOOLBAR_HEIGHT_PX, width: FULL_WIDTH_PX, borderBottom: '1px solid black' } },
            h("label", { htmlFor: "context" }, "Select context placement:"),
            h("select", { id: "context", name: "context", ref: el => {
                    this.selectList = el;
                }, onChange: () => {
                    var _a;
                        ...
                        h("div", null,
                            h("div", null,
                                h("div", { style: {
                                    ...
                                    chart(1000, 1000))),
                            h("div", null)),
                        this.contextPlacement === 'element' && h("sc-webgl-context", { viewFrame: this.elementRef }))),
                sidePanel),
            this.contextPlacement === 'viewport' && h("sc-webgl-context", null)));
    }
    static get is() { return "sc-webgl-context-nested"; }
