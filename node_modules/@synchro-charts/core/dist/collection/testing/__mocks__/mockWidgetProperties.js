 ...
 */
// Empty Number
export const NUMBER_EMPTY_INFO = {
    id: 'empty-info-id',
    resolution: 0,
...
export const NUMBER_EMPTY_STREAM = {
 ...
 */
// Empty String
export const STRING_EMPTY_INFO = {
...
export const STRING_EMPTY_STREAM = {
...
export const ALARM_STREAM_INFO = {
    id: 'alarm-stream',
    resolution: 0,
    dataType: DataType.STRING,
...
export const NON_BREACHED_ALARM_INFO = {
    id: 'alarm-stream-2',
    resolution: 0,
    dataType: DataType.STRING,
    streamType: StreamType.ALARM,
...
export const DATA_WITH_ALARM_INFO = Object.assign(Object.assign({}, DATA_STREAM_INFO), { associatedStreams: [
...
export const DATA_WITH_ALARM_ASSOCIATION = Object.assign(Object.assign({}, DATA_STREAM), { associatedStreams: [
        { id: ALARM_STREAM.id, type: StreamType.ALARM },
        { id: NON_BREACHED_ALARM_INFO.id, type: StreamType.ALARM },
    ] });
export const NON_BREACHED_ALARM_STREAM = {
