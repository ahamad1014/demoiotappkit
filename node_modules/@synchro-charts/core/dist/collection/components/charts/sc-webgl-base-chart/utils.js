 ...
 */
export const vertices = (stream, resolution) => {
 ...
 */
export const constructChartScene = ({ scene, container, viewport, toClipSpace, onUpdate, }) => {
 ...
 */
export const numDataPoints = (dataStreams) => dataStreams.map(stream => getDataPoints(stream, stream.resolution).length).reduce((total, num) => total + num, 0);
