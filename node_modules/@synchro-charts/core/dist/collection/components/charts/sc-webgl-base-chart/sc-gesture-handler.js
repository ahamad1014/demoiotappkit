...
export class ScGestureHandler {
    ...
    render() {
        const { width, height } = this.size;
        return (h("svg", null,
            this.start != null && this.end != null && h("line", { x1: this.start, y1: 0, x2: this.start, y2: height }),
            this.start != null && this.end != null && (h("rect", { class: "brush-box", x: Math.min(this.start, this.end), height: height, width: Math.abs(this.end - this.start), y: 0 })),
            this.start != null && this.end != null && h("line", { x1: this.end, y1: 0, x2: this.end, y2: height }),
            h("rect", { class: "overlay zoom-container", width: width, height: height })));
    }
    static get is() { return "sc-gesture-handler"; }
    static get originalStyleUrls() { return {
        "$": ["sc-gesture-handler.css"]
    }; }
    ...
    static get properties() { return {
        ...
        "onDateRangeChange": {
            ...
            "mutable": false,
            "complexType": {
                "original": "({ end, start }: { start: Date; end: Date }) => void",
                "resolved": "({ end, start }: { start: Date; end: Date; }) => void",
                "references": {
                    "Date": {
                        "location": "global"
                    }
