 ...
 * Create Point Mesh
 */
export const pointMesh = ({ toClipSpace, dataStreams, minBufferSize, bufferFactor, thresholdOptions, thresholds, }) => {
 ...
 */
export const updatePointMesh = (dataStreams, points, toClipSpace, hasDataChanged = true) => {
    /**
     * Update Uniforms
     *
