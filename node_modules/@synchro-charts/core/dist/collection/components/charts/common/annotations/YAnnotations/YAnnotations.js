...
export const renderYAnnotationsEditable = ({ container, yAnnotations, viewport, resolution, size: { width, height }, }) => {
...
export const renderYAnnotations = ({ container, yAnnotations, viewport, resolution, size: { width, height }, }) => {
    const getYPosition = (annotation) => getY({
        annotation,
        height,
        viewport,
...
export const removeYAnnotations = ({ container }) => {
    /**
