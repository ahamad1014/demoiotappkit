 ...
 */
export const computeTrendResult = (dataStream, trendType) => {
    switch (trendType) {
 ...
 */
export const getAllTrendResults = (viewport, dataStreams, trends) => {
    const trendResults = [];
 ...
 */
export const getTrendValue = (trendResult, timestamp) => {
