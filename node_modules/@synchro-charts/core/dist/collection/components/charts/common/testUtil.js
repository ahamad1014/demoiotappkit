 ...
 */
export const CHART_CONFIG = Object.assign(Object.assign({}, DEFAULT_CHART_CONFIG), { widgetId: 'base-chart-config', viewport: VIEWPORT, size: { width: 500, height: 500, marginLeft: 100, marginRight: 40, marginTop: 40, marginBottom: 100 }, movement: {
        enableXScroll: true,
        enableYScroll: false,
        zoomMax: 40,
        zoomMin: 0.1,
