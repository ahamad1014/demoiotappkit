...
export const lineMesh = ({ viewport, dataStreams, chartSize, minBufferSize, bufferFactor, toClipSpace, thresholdOptions, thresholds, }) => {
...
export const updateLineMesh = ({ chartSize, toClipSpace, lines, dataStreams, viewport, hasDataChanged, }) => {
    /**
     * Update Uniforms
     */
    const { x: xPixelDensity, y: yPixelDensity } = pixelDensity({ viewport, toClipSpace, size: chartSize });
