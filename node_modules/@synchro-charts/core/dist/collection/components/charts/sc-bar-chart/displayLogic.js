...
export const getBarMargin = (toClipSpace, resolution) => getDistanceFromDuration(toClipSpace, resolution * MARGIN_FACTOR);
/**
 * Get the bar width
 *
 ...
 */
export const getBarWidth = ({ toClipSpace, resolution, numDataStreams, }) => {
