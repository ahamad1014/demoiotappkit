...
(function(s){s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='stencilredux']"));
...
function t(n,t){for(var r,e,i=null,u=!1,o=!1,f=arguments.length;f-- >2;)P.push(arguments[f]);for(;P.length>0;){var c=P.pop();if(c&&void 0!==c.pop)for(f=c.length;f--;)P.push(c[f]);else"boolean"==typeof c&&(c=null),(o="function"!=typeof n)&&(null==c?c="":"number"==typeof c?c=String(c):"string"!=typeof c&&(o=!1)),o&&u?i[i.length-1].vtext+=c:null===i?i=[o?{vtext:c}:c]:i.push(o?{vtext:c}:c),u=o}if(null!=t){if(t.className&&(t.class=t.className),"object"==typeof t.class){for(f in t.class)t.class[f]&&P.push(f);t.class=P.join(" "),P.length=0}null!=t.key&&(r=t.key),null!=t.name&&(e=t.name)}return"function"==typeof n?n(t,i||[],D):{vtag:n,vchildren:i,vtext:void 0,vattrs:t,vkey:r,vname:e,t:void 0,i:!1}}function e(n,t,r){n.lastIndex=0;var e=t.substring(r).match(n);if(e){var i=r+e.index;return{start:i,end:i+e[0].length}}return null}function i(n,t,r){var i=function o(n,t){var r=e(tn,n,t);if(!r)return null;var i=function u(n,t){for(var r=0,e=t;e<n.length;e++){var i=n[e];if("("===i)r++;else if(")"===i&&--r<=0)return e+1}return e}(n,r.start),o=n.substring(r.end,i-1).split(","),f=o[0],c=o.slice(1);return{start:r.start,end:i,u:f.trim(),fallback:c.length>0?c.join(",").trim():void 0}}(n,r);if(!i)return t.push(n.substring(r,n.length)),n.length;var c=i.u,a=null!=i.fallback?f(i.fallback):void 0;return t.push(n.substring(r,i.start),function(n){return function t(n,r,e){return n[r]?n[r]:e?u(e,n):""}(n,c,a)}),i.end}function u(n,t){for(var r="",e=0;e<n.length;e++){var i=n[e];r+="string"==typeof i?i:i(t)}return r}function o(n,t){for(var r=!1,e=!1,i=t;i<n.length;i++){var u=n[i];if(r)e&&'"'===u&&(r=!1),e||"'"!==u||(r=!1);else if('"'===u)r=!0,e=!0;else if("'"===u)r=!0,e=!1;else{if(";"===u)return i+1;if("}"===u)return i}}return i}function f(n){var t=0;n=function r(n){for(var t="",r=0;;){var i=e(rn,n,r),u=i?i.start:n.length;if(t+=n.substring(r,u),!i)break;r=o(n,u)}return t}(n=n.replace(en,"")).replace(un,"");for(var u=[];t<n.length;)t=i(n,u,t);return u}function a(n){var t={};n.forEach(function(n){n.o.forEach(function(n){t[n.s]=n.value})});for(var r={},e=Object.entries(t),i=function(){var n=!1;if(e.forEach(function(t){var e=t[0],i=u(t[1],r);i!==r[e]&&(r[e]=i,n=!0)}),!n)return"break"},o=0;o<10&&"break"!==i();o++);return r}function s(n,t){if(void 0===t&&(t=0),!n.rules)return[];var r=[];return n.rules.filter(function(n){return n.type===G.STYLE_RULE}).forEach(function(n){var e=function i(n){for(var t,r=[];t=fn.exec(n.trim());){var e=l(t[2]),i=e.value,u=e.l;r.push({s:t[1].trim(),value:f(i),l:u})}return r}(n.cssText);e.length>0&&n.parsedSelector.split(",").forEach(function(n){n=n.trim(),r.push({selector:n,o:e,v:1,p:t})}),t++}),r}function l(n){var t=(n=n.replace(/\s+/gim," ").trim()).endsWith(on);return t&&(n=n.substr(0,n.length-on.length).trim()),{value:n,l:t}}function v(n){var t=[];return n.forEach(function(n){t.push.apply(t,n.m)}),t}function p(n){var t=function r(n){return function n(t,r){var e=r.substring(t.start,t.end-1);if(t.parsedCssText=t.cssText=e.trim(),t.parent){var i=t.previous?t.previous.end:t.parent.start;e=(e=(e=function u(n){return n.replace(/\\([0-9a-f]{1,6})\s/gi,function(){for(var n=arguments[1],t=6-n.length;t--;)n="0"+n;return"\\"+n})}(e=r.substring(i,t.start-1))).replace(X.g," ")).substring(e.lastIndexOf(";")+1);var o=t.parsedSelector=t.selector=e.trim();t.atRule=0===o.indexOf(nn),t.atRule?0===o.indexOf(V)?t.type=G.MEDIA_RULE:o.match(X.k)&&(t.type=G.KEYFRAMES_RULE,t.keyframesName=t.selector.split(X.g).pop()):0===o.indexOf(J)?t.type=G.M:t.type=G.STYLE_RULE}var f=t.rules;if(f)for(var c=0,a=f.length,s=void 0;c<a&&(s=f[c]);c++)n(s,r);return t}(function r(n){var t=new z;t.start=0,t.end=n.length;for(var r=t,e=0,i=n.length;e<i;e++)if(n[e]===K){r.rules||(r.rules=[]);var u=r,o=u.rules[u.rules.length-1]||null;(r=new z).start=e+1,r.parent=u,r.previous=o,u.rules.push(r)}else n[e]===Q&&(r.end=e+1,r=r.parent||t);return t}(n=function t(n){return n.replace(X.j,"").replace(X.port,"")}(n)),n)}(n),e=f(n);return{C:n,S:e,m:s(t),W:e.length>1}}function m(n,t){var r=p(t.innerHTML);r.R=t,n.push(r)}function y(n,t,r){return function e(n,t,r){return n.replace(new RegExp(t,"g"),r)}(n,"\\."+t,"."+r)}function b(n,t,r){var e=r.href;return fetch(e).then(function(n){return n.text()}).then(function(i){if(function u(n){return n.indexOf("var(")>-1||cn.test(n)}(i)&&r.parentNode){(function o(n){return an.lastIndex=0,an.test(n)})(i)&&(i=function f(n,t){var r=t.replace(/[^\/]*$/,"");return n.replace(an,function(n,t){var e=r+t;return n.replace(t,e)})}(i,e));var c=n.createElement("style");c.innerHTML=i,m(t,c),r.parentNode.insertBefore(c,r),r.remove()}}).catch(function(n){console.error(n)})}var g,k=this&&this.A||function(n,t,r,e){return new(r||(r=Promise))(function(i,u){function o(n){try{c(e.next(n))}catch(n){u(n)}}function f(n){try{c(e.throw(n))}catch(n){u(n)}}function c(n){n.done?i(n.value):new r(function(t){t(n.value)}).then(o,f)}c((e=e.apply(n,t||[])).next())})},M=this&&this.O||function(n,t){function r(r){return function(o){return function c(r){if(e)throw new TypeError("Generator is already executing.");for(;f;)try{if(e=1,i&&(u=2&r[0]?i.return:r[0]?i.throw||((u=i.return)&&u.call(i),0):i.next)&&!(u=u.call(i,r[1])).done)return u;switch(i=0,u&&(r=[2&r[0],u.value]),r[0]){case 0:case 1:u=r;break;case 4:return f.label++,{value:r[1],done:!1};case 5:f.label++,i=r[1],r=[0];continue;case 7:r=f.N.pop(),f.L.pop();continue;default:if(!(u=(u=f.L).length>0&&u[u.length-1])&&(6===r[0]||2===r[0])){f=0;continue}if(3===r[0]&&(!u||r[1]>u[0]&&r[1]<u[3])){f.label=r[1];break}if(6===r[0]&&f.label<u[1]){f.label=u[1],u=r;break}if(u&&f.label<u[2]){f.label=u[2],f.N.push(r);break}u[2]&&f.N.pop(),f.L.pop();continue}r=t.call(n,f)}catch(n){r=[6,n],i=0}finally{e=u=0}if(5&r[0])throw r[1];return{value:r[0]?r[1]:void 0,done:!0}}([r,o])}}var e,i,u,o,f={label:0,T:function(){if(1&u[0])throw u[1];return u[1]},L:[],N:[]};return o={next:r(0),throw:r(1),return:r(2)},"function"==typeof Symbol&&(o[Symbol.iterator]=function(){return this}),o},$=this,E={},j=function(n){return null!=n},C=function(n){return n.toLowerCase()},S="http://www.w3.org/1999/xlink",W=function(n,t,r,e,i,u){if("class"!==r||u)if("style"===r)for(var o in i)e&&i[o]===e[o]||(/-/.test(o)?t.style.setProperty(o,i[o]):t.style[o]=i[o]);else"o"!==r[0]||"n"!==r[1]||!/[A-Z]/.test(r[2])||r in t?"list"!==r&&"type"!==r&&!u&&(r in t||-1!==["object","function"].indexOf(typeof i)&&null!==i)?(n.P(t),"ref"!==r&&(R(t,r,null==i?"":i),null!=i&&!1!==i||n.I.D(t,r))):null!=i&&"key"!==r?function(n,t,r,e,i){void 0===e&&(e="boolean"==typeof r),i=t!==(t=t.replace(/^xlink\:?/,"")),null==r||e&&(!r||"false"===r)?i?n.removeAttributeNS(S,C(t)):n.removeAttribute(t):"function"!=typeof r&&(r=e?"":r.toString(),i?n.setAttributeNS(S,C(t),r):n.setAttribute(t,r))}(t,r,i):(u||n.I.q(t,r)&&(null==i||!1===i))&&n.I.D(t,r):(r=C(r)in t?C(r.substring(2)):C(r[2])+r.substring(3),i&&i!==e&&n.I.U(t,r,i,0));else t.className=i},R=function(n,t,r){try{n[t]=r}catch(n){}},A=function(n,t,r,e,i){var u=11===r.t.nodeType&&r.t.host?r.t.host:r.t,o=t&&t.vattrs||E,f=r.vattrs||E;for(i in f)i in o&&f[i]===("value"===i||"checked"===i?u[i]:o[i])||W(n,u,i,o[i],f[i],e,r.i)},O=!1,N=function(n,t){var r,e,i,u,o,f,c,a=function(i,l,v,p,h,d,m,w,y){if(w=l.vchildren[v],r||(u=!0,"slot"===w.vtag&&(e&&t._(p,e+"-s"),w.vchildren?w.B=!0:w.H=!0)),j(w.vtext))w.t=t.F(w.vtext);else if(w.H)w.t=t.F("");else{if(d=w.t=O||"svg"===w.vtag?t.Y("http://www.w3.org/2000/svg",w.vtag):t.Z(w.B?"slot-fb":w.vtag),n.G(d)&&n.K.delete(c),O="svg"===w.vtag||"foreignObject"!==w.vtag&&O,A(n,null,w,O),j(e)&&d["s-si"]!==e&&t._(d,d["s-si"]=e),w.vchildren)for(h=0;h<w.vchildren.length;++h)(m=a(i,w,h,d))&&t.X(d,m);"svg"===w.vtag&&(O=!1)}return w.t["s-hn"]=f,(w.B||w.H)&&(w.t["s-sr"]=!0,w.t["s-cr"]=o,w.t["s-sn"]=w.vname||"",(y=i&&i.vchildren&&i.vchildren[v])&&y.vtag===w.vtag&&i.t&&s(i.t)),w.t},s=function(r,e,i,o){n.J=!0;var c=t.V(r);for(i=c.length-1;i>=0;i--)(o=c[i])["s-hn"]!==f&&o["s-ol"]&&(t.nn(o),t.tn(v(o),o,l(o)),t.nn(o["s-ol"]),o["s-ol"]=null,u=!0),e&&s(o,e);n.J=!1},l=function(n){return n&&n["s-ol"]?n["s-ol"]:n},v=function(n){return t.rn(n["s-ol"]?n["s-ol"]:n)},p=function(n,r,e,i,u,o,f,c){for(i=0,u=(e=t.V(n)).length;i<u;i++)if(r=e[i],1===t.en(r)){if(r["s-sr"])for(f=r["s-sn"],r.hidden=!1,o=0;o<u;o++)if(e[o]["s-hn"]!==r["s-hn"])if(c=t.en(e[o]),""!==f){if(1===c&&f===t.in(e[o],"slot")){r.hidden=!0;break}}else if(1===c||3===c&&""!==t.un(e[o]).trim()){r.hidden=!0;break}p(r)}},h=[],d=function(n,r,e,u,o,f,c,a,s,l){for(o=0,f=(r=t.V(n)).length;o<f;o++){if((e=r[o])["s-sr"]&&(u=e["s-cr"]))for(a=t.V(t.rn(u)),s=e["s-sn"],c=a.length-1;c>=0;c--)(u=a[c])["s-cn"]||u["s-nr"]||u["s-hn"]===e["s-hn"]||((3===(l=t.en(u))||8===l)&&""===s||1===l&&null===t.in(u,"slot")&&""===s||1===l&&t.in(u,"slot")===s)&&(h.some(function(n){return n.on===u})||(i=!0,u["s-sn"]=s,h.push({fn:e,on:u})));1===t.en(e)&&d(e)}};return function(s,v,m,w,y,b,g,k,M,$,E,x){if(c=s,f=t.cn(c),o=c["s-cr"],r=w,e=c["s-sc"],u=i=!1,function(r,e,i){var u=e.t=r.t,o=(r.vchildren,e.vchildren);O=e.t&&j(t.an(e.t))&&void 0!==e.t.ownerSVGElement,O="svg"===e.vtag||"foreignObject"!==e.vtag&&O,j(e.vtext)?(i=u["s-cr"])?t.sn(t.rn(i),e.vtext):r.vtext!==e.vtext&&t.sn(u,e.vtext):("slot"!==e.vtag&&A(n,r,e,O),j(o)&&function(n,r,e,i,u,o,c,s){var v=n["s-cr"];for((c=v&&t.rn(v)||n).shadowRoot&&t.cn(c)===f&&(c=c.shadowRoot);u<=o;++u)i[u]&&(s=j(i[u].vtext)?t.F(i[u].vtext):a(null,e,u,n))&&(i[u].t=s,t.tn(c,s,l(null)))}(u,0,e,o,0,o.length-1)),O&&"svg"===e.vtag&&(O=!1)}(v,m),u){for(d(m.t),g=0;g<h.length;g++)(k=h[g]).on["s-ol"]||((M=t.F(""))["s-nr"]=k.on,t.tn(t.rn(k.on),k.on["s-ol"]=M,k.on));for(n.J=!0,g=0;g<h.length;g++){for(k=h[g],E=t.rn(k.fn),x=t.ln(k.fn),M=k.on["s-ol"];M=t.vn(M);)if(($=M["s-nr"])&&$&&$["s-sn"]===k.on["s-sn"]&&E===t.rn($)&&($=t.ln($))&&$&&!$["s-nr"]){x=$;break}(!x&&E!==t.rn(k.on)||t.ln(k.on)!==x)&&k.on!==x&&(t.nn(k.on),t.tn(E,k.on,x))}n.J=!1}return i&&p(m.t),h.length=0,m}},L=function(n,t){n&&(n.vattrs&&n.vattrs.ref&&n.vattrs.ref(t?null:n.t),n.vchildren&&n.vchildren.forEach(function(n){L(n,t)}))},T=function(n,t){var r=Promise.resolve(),e=function(n){r.then(function(){try{n(t.performance.now())}catch(n){console.error(n)}})};return{tick:e,read:e,write:e}},P=[],D={forEach:function(n,t){return n.forEach(t)},map:function(n,t){return n.map(t)}},I=function(n){return{pn:n[0],hn:n[1],dn:!!n[2],mn:!!n[3],wn:!!n[4]}},q=function(n,t,r){n.yn.add(t),n.bn.has(t)||(n.bn.set(t,!0),n.gn?n.queue.write(function(){return U(n,t,r)}):n.queue.tick(function(){return U(n,t,r)}))},U=function(n,r,e,i,u,o){return k($,void 0,void 0,function(){var i,f;return M(this,function(c){switch(c.label){case 0:return n.bn.delete(r),n.kn.has(r)?[3,12]:(u=n.Mn.get(r))?[3,6]:(o=n.$n.get(r))&&!o["s-rn"]?((o["s-rc"]=o["s-rc"]||[]).push(function(){U(n,r,e)}),[2]):(u=_(n,r,n.En.get(r),e),[3,5]);case 1:return c.L.push([1,4,,5]),u.componentWillLoad?[4,u.componentWillLoad()]:[3,3];case 2:c.T(),c.label=3;case 3:return[3,5];case 4:return i=c.T(),n.jn(i,3,r),[3,5];case 5:case 6:return[3,11];case 7:return c.L.push([7,10,,11]),u.componentWillUpdate?[4,u.componentWillUpdate()]:[3,9];case 8:c.T(),c.label=9;case 9:return[3,11];case 10:return f=c.T(),n.jn(f,5,r),[3,11];case 11:(function(n,r,e,i){try{var u=r.xn.host,o=r.xn.encapsulation,f=e;if(i.render||i.hostData||u){n.Cn=!0;var c=i.render&&i.render();n.Cn=!1;var a=t(null,void 0,c),s=n.Sn.get(e)||{};s.t=f,n.Sn.set(e,n.render(e,s,a,!1,o))}n.Wn&&n.Wn.updateHost(e),e["s-rn"]=!0,e["s-rc"]&&(e["s-rc"].forEach(function(n){return n()}),e["s-rc"]=null)}catch(t){n.Cn=!1,n.jn(t,8,e,!0)}})(n,n.P(r),r,u),r["s-init"](),c.label=12;case 12:return[2]}})})},_=function(n,t,r,e,i,u){try{i=new(u=n.P(t).xn),function(n,t,r,e){n.Rn.set(e,r),n.An.has(r)||n.An.set(r,{}),Object.entries(Object.assign({color:{type:String}},t.properties,{mode:{type:String}})).forEach(function(n){n[0],n[1]})}(n,u,t,i)}catch(r){i={},n.jn(r,7,t,!0)}return n.Mn.set(t,i),i},B=function(n,t){for(var r=0;r<t.childNodes.length;r++){var e=t.childNodes[r];if(1===e.nodeType){if(n.P(e)&&!n.On.has(e))return!1;if(!B(n,e))return!1}}return!0},H=function(n,t,r,e,i,u){if(n.yn.delete(t),(i=n.$n.get(t))&&((e=i["s-ld"])&&((r=e.indexOf(t))>-1&&e.splice(r,1),e.length||i["s-init"]&&i["s-init"]()),n.$n.delete(t)),n.Nn.length&&!n.yn.size)for(;u=n.Nn.shift();)u()},F=function(n,t,r,e,i){r.connectedCallback=function(){(function(n,t,r){n.kn.delete(r),n.On.has(r)||(n.Ln=!0,n.yn.add(r),n.On.set(r,!0),function(n,t,r){for(r=t;r=n.I.an(r);)if(n.G(r)){n.K.has(t)||(n.$n.set(t,r),(r["s-ld"]=r["s-ld"]||[]).push(t));break}}(n,r),n.queue.tick(function(){n.En.set(r,function(n,t,r){if(r.mode||(r.mode=n.Tn(r)),r["s-cr"]||n.in(r,"ssrv")||n.Pn&&1===t.Dn||(r["s-cr"]=n.F(""),r["s-cr"]["s-cn"]=!0,n.tn(r,r["s-cr"],n.V(r)[0])),!n.Pn&&1===t.Dn)try{!window.HTMLElement||"shadowRoot"in window.HTMLElement.prototype||(r.shadowRoot=r)}catch(n){}return{In:{}}}(n.I,t,r)),n.qn(t,r)}))})(n,t,this)},r.disconnectedCallback=function(){(function(n,t){!n.J&&function(n,t){for(;t;){if(!n.rn(t))return 9!==n.en(t);t=n.rn(t)}}(n.I,t)&&(n.kn.set(t,!0),H(n,t),L(n.Sn.get(t),!0),n.I.Un(t),n._n.delete(t),n.Wn&&n.Wn.removeHost(t),[n.$n,n.Bn,n.En].forEach(function(n){return n.delete(t)}))})(n,this)},r["s-init"]=function(){(function(n,t,r,e,i,u){if(B(n,t)&&n.Mn.get(t)&&!n.kn.has(t)&&(!t["s-ld"]||!t["s-ld"].length)){n.K.set(t,!0),n.Hn.has(t)||(n.Hn.set(t,!0),t["s-ld"]=void 0,n.I._(t,r));try{L(n.Sn.get(t)),(u=n.Bn.get(t))&&(u.forEach(function(n){return n(t)}),n.Bn.delete(t))}catch(r){n.jn(r,4,t)}H(n,t)}})(n,this,e)},r.forceUpdate=function(){q(n,this,i)}},Y=function(n,t,r,e){return function(){var i=arguments;return Z(n,t,r).then(function(n){return n[e].apply(n,i)})}},Z=function(n,t,r,e,i){return e=t[r],(i=n.Fn.body)?(e||(e=i.querySelector(r)),e||(e=t[r]=n.Z(r),n.X(i,e)),e.componentOnReady()):Promise.resolve()},z=function z(){this.start=0,this.end=0,this.previous=null,this.parent=null,this.rules=null,this.parsedCssText="",this.cssText="",this.atRule=!1,this.type=0,this.keyframesName="",this.selector="",this.parsedSelector=""},G={STYLE_RULE:1,KEYFRAMES_RULE:7,MEDIA_RULE:4,M:1e3},K="{",Q="}",X={j:/\/\*[^*]*\*+([^\/*][^*]*\*+)*\//gim,port:/@import[^;]*;/gim,Yn:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,Zn:/(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?{[^}]*?}(?:[;\n]|$)?/gim,zn:/@apply\s*\(?[^);]*\)?\s*(?:[;\n]|$)?/gim,Gn:/[^;:]*?:[^;]*?var\([^;]*\)(?:[;\n]|$)?/gim,k:/^@[^\s]*keyframes/,g:/\s+/g},J="--",V="@media",nn="@",tn=/\bvar\(/,rn=/\B--[\w-]+\s*:/,en=/\/\*[^*]*\*+([^\/*][^*]*\*+)*\//gim,un=/^[\t ]+\n/gm,on="!important",fn=/(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gm,cn=/[\s;{]--[-a-zA-Z0-9]+\s*:/m,an=/url[\s]*\([\s]*['"]?(?![http|\/])([^\'\"\)]*)[\s]*['"]?\)[\s]*/gim,sn=function(){function n(n,t){this.Kn=n,this.Qn=t,this.count=0,this.Xn=new WeakMap,this.Jn=new WeakMap,this.Vn=[],this.nt=new Map}return n.prototype.initShim=function(){var n=this;return new Promise(function(t){n.Kn.requestAnimationFrame(function(){(function r(n,t){return function r(n,t){for(var r=[],e=n.querySelectorAll('link[rel="stylesheet"][href]'),i=0;i<e.length;i++)r.push(b(n,t,e[i]));return Promise.all(r)}(n,t).then(function(){(function r(n,t){for(var r=n.querySelectorAll("style"),e=0;e<r.length;e++)m(t,r[e])})(n,t)})})(n.Qn,n.Vn).then(function(){return t()})})})},n.prototype.tt=function(n){var t=this;return b(this.Qn,this.Vn,n).then(function(){t.updateGlobal()})},n.prototype.rt=function(n){m(this.Vn,n),this.updateGlobal()},n.prototype.createHostStyle=function(n,t,r){if(this.Jn.has(n))return null;var e=n["s-sc"],i=this.et(r,t,e),o=i.W&&i.it;if(!o&&i.R)return null;var f=this.Qn.createElement("style");if(o){var c=i.it+"-"+this.count;n["s-sc"]=c,this.Xn.set(n,f),this.Jn.set(n,function a(n,t){var r=n.S.map(function(r){return"string"==typeof r?y(r,n.it,t):r}),e=n.m.map(function(r){return Object.assign({},r,{selector:y(r.selector,n.it,t)})});return Object.assign({},n,{S:r,m:e,it:t})}(i,c)),this.count++}else i.R=f,i.W||(f.innerHTML=u(i.S,{})),this.Vn.push(i),this.updateGlobal(),this.Jn.set(n,i);return f},n.prototype.removeHost=function(n){var t=this.Xn.get(n);t&&t.remove(),this.Xn.delete(n),this.Jn.delete(n)},n.prototype.updateHost=function(n){var t=this.Jn.get(n);if(t&&t.W&&t.it){var r=this.Xn.get(n);if(r){var e=a(function i(n,t,r){return function i(n){return n.sort(function(n,t){return n.v===t.v?n.p-t.p:n.v-t.v}),n}(v(r.concat(function e(n,t){for(var r=[];t;){var e=n.get(t);e&&r.push(e),t=t.parentElement}return r}(t,n))).filter(function(t){return function r(n,t){return n.matches(t)}(n,t.selector)}))}(n,this.Jn,this.Vn));r.innerHTML=u(t.S,e)}}},n.prototype.updateGlobal=function(){(function n(t){var r=a(v(t));t.forEach(function(n){n.W&&(n.R.innerHTML=u(n.S,r))})})(this.Vn)},n.prototype.et=function(n,t,r){var e=this.nt.get(t);return e||((e=p(n)).it=r,this.nt.set(t,e)),e},n}();!function ln(n){return!!(n.CSS&&n.CSS.supports&&n.CSS.supports("color","var(--c)"))}(window)&&(g=new sn(w,d)),function vn(n,r,e,i,u,o,f,c){function a(n,t){e.customElements.get(n.ut)||(x[n.ut]=!0,F(W,b[n.ut]=n,t.prototype,o,y),e.customElements.define(n.ut,t))}function s(n){return null==n?null:k.get(n.replace(/^\.\//,""))}function l(n){return"exports"===n||"require"===n||!!s(n)}function v(n,t,r){var e={};try{r.apply(null,t.map(function(n){return"exports"===n?e:"require"===n?p:s(n)}))}catch(n){console.error(n)}void 0!==n&&(k.set(n,e),n&&!n.endsWith(".js")&&Object.keys(e).forEach(function(n){for(var t=n.replace(/-/g,"").toLowerCase(),r=Object.keys(b),i=0;i<r.length;i++)if(r[i].replace(/-/g,"").toLowerCase()===t){var u=b[r[i]];u&&(u.xn=e[n]);break}}))}function p(n,t){d(void 0,n,t)}function h(){for(var n=g.length-1;n>=0;n--){var t=g[n],r=t[0],e=t[1],i=t[2];e.every(l)&&!l(r)&&(g.splice(n,1),v(r,e,i))}}function d(n,t,r){if(Array.isArray(t)){var e=t.filter(function(n){return!l(n)});e.forEach(function(n){w(u+n.replace(".js",".es5.js"))}),g.push([n,t,r]),0===e.length&&h()}else"function"==typeof t&&h()}function m(n){w(u+n+".es5.entry.js")}function w(n){function t(){clearTimeout(r),e.onerror=e.onload=null,j.nn(e),M.delete(n)}var r,e;M.has(n)||(M.add(n),(e=j.Z("script")).charset="utf-8",e.async=!0,e.src=n,r=setTimeout(t,12e4),e.onerror=e.onload=t,j.X(j.Fn.head,e))}var y=e.performance,b={html:{}},g=[],k=new Map,M=new Set,$={},E=e[n]=e[n]||{},j=function(n,t,r){var e=new WeakMap,i={Fn:r,Pn:!!r.documentElement.attachShadow,ot:!1,en:function(n){return n.nodeType},Z:function(n){return r.createElement(n)},Y:function(n,t){return r.createElementNS(n,t)},F:function(n){return r.createTextNode(n)},ft:function(n){return r.createComment(n)},tn:function(n,t,r){return n.insertBefore(t,r)},nn:function(n){return n.remove()},X:function(n,t){return n.appendChild(t)},_:function(n,t){if(n.classList)n.classList.add(t);else if("svg"===n.nodeName.toLowerCase()){var r=n.getAttribute("class")||"";r.split(" ").includes(t)||(r+=" "+t),n.setAttribute("class",r.trim())}},V:function(n){return n.childNodes},rn:function(n){return n.parentNode},ln:function(n){return n.nextSibling},vn:function(n){return n.previousSibling},cn:function(n){return C(n.nodeName)},un:function(n){return n.textContent},sn:function(n,t){return n.textContent=t},in:function(n,t){return n.getAttribute(t)},ct:function(n,t,r){return n.setAttribute(t,r)},D:function(n,t){return n.removeAttribute(t)},q:function(n,t){return n.hasAttribute(t)},Tn:function(t){return t.getAttribute("mode")||(n.Context||{}).mode},at:function(n,e){return"child"===e?n.firstElementChild:"parent"===e?i.an(n):"body"===e?r.body:"document"===e?r:"window"===e?t:n},U:function(t,r,u,o,f,c,a,s,l,v){var p=t,h=u,d=e.get(t);v=r+o,d&&d[v]&&d[v](),"object"==typeof a&&(p=a),p&&(s=i.ot?{capture:!!f,passive:!!c}:!!f,n.ael(p,r,h,s),d||e.set(t,d={}),d[v]=function(){p&&n.rel(p,r,h,s),d[v]=null})},Un:function(n,t,r,i){(i=e.get(n))&&(t?i[t+r]&&i[t+r]():Object.keys(i).forEach(function(n){i[n]&&i[n]()}))},st:function(n,r,e,i){return i=new t.CustomEvent(r,e),n&&n.dispatchEvent(i),i},an:function(n,t){return(t=i.rn(n))&&11===i.en(t)?t.host:t},lt:function(n,t,r,e){return n.setAttributeNS(t,r,e)}};return"function"!=typeof t.CustomEvent&&(t.CustomEvent=function(n,t,e){return t=t||{},(e=r.createEvent("CustomEvent")).initCustomEvent(n,t.bubbles,t.cancelable,t.detail),e},t.CustomEvent.prototype=t.Event.prototype),n.ael||(n.ael=function(n,t,r,e){return n.addEventListener(t,r,e)},n.rel=function(n,t,r,e){return n.removeEventListener(t,r,e)}),i}(E,e,i);r.isServer=r.isPrerender=!(r.isClient=!0),r.window=e,r.location=e.location,r.document=i,r.resourcesUrl=r.publicPath=u,E.h=t,E.Context=r;var x=e["s-defined"]=e["s-defined"]||{},S=0,W={I:j,vt:a,pt:r.emit,Wn:c,P:function(n){return b[j.cn(n)]},ht:function(n){return r[n]},isClient:!0,G:function(n){return!(!x[j.cn(n)]&&!W.P(n))},jn:function(n,t,r){return console.error(n,t,r&&r.tagName)},dt:function(){return n+S++},wt:function(n){return function(n,t,r){return{create:Y(n,t,r,"create"),componentOnReady:Y(n,t,r,"componentOnReady")}}(j,$,n)},queue:r.queue=T(0,e),qn:function R(n,t){var r="string"==typeof n.yt?n.yt:n.yt[t.mode];s(r)?q(W,t,y):(g.push([void 0,[r],function(){q(W,t,y)}]),c&&O?O.push(function(){return m(r)}):m(r))},gn:!1,Cn:!1,J:!1,$n:new WeakMap,bt:new WeakMap,On:new WeakMap,_n:new WeakMap,Hn:new WeakMap,K:new WeakMap,Rn:new WeakMap,En:new WeakMap,Mn:new WeakMap,kn:new WeakMap,bn:new WeakMap,Bn:new WeakMap,gt:new WeakMap,Sn:new WeakMap,An:new WeakMap,yn:new Set,Nn:[]};E.onReady=function(){return new Promise(function(n){return W.queue.write(function(){return W.yn.size?W.Nn.push(n):n()})})},W.render=N(W,j);var A=j.Fn.documentElement;A["s-ld"]=[],A["s-rn"]=!0,A["s-init"]=function(){W.K.set(A,E.loaded=W.gn=!0),j.st(e,"appload",{detail:{namespace:n}})},E.loadBundle=d;var O=[];c&&c.initShim().then(function(){for(;O.length;)O.shift()();O=null}),f.map(function(n){var t,r,e,i,u,o=(r=(t=n)[0],e=t[1],t[3],i=t[4],u=t[5],{ut:r,yt:e,kt:Object.assign({},{color:{Mt:"color"}}),Dn:i,$t:u?u.map(I):void 0});return b[o.ut]=o}).forEach(function(n){function t(n){return HTMLElement.call(this,n)}t.prototype=Object.create(HTMLElement.prototype,{constructor:{value:t,configurable:!0}}),a(n,t)}),W.Ln||A["s-init"](),function(n,t,r,e,i,u){if(t.componentOnReady=function(t,r){if(!t.nodeName.includes("-"))return r(null),!1;var e=n.P(t);if(e)if(n.K.has(t))r(t);else{var i=n.Bn.get(t)||[];i.push(r),n.Bn.set(t,i)}return!!e},i){for(u=i.length-1;u>=0;u--)t.componentOnReady(i[u][0],i[u][1])&&i.splice(u,1);for(u=0;u<e.length;u++)if(!r[e[u]].componentOnReady)return;for(u=0;u<i.length;u++)i[u][1](null);i.length=0}}(W,E,e,e["s-apps"],e["s-cr"]),E.initialized=!0}(n,x,w,d,r,h,c,g);
})(window,document,{},"stencilredux","hydrated",[]);