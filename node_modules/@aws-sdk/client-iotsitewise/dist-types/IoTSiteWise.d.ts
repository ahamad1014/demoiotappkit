...
export interface IoTSiteWise {
     ...
     */
    createAssetModelCompositeModel(args: CreateAssetModelCompositeModelCommandInput, options?: __HttpHandlerOptions): Promise<CreateAssetModelCompositeModelCommandOutput>;
    createAssetModelCompositeModel(args: CreateAssetModelCompositeModelCommandInput, cb: (err: any, data?: CreateAssetModelCompositeModelCommandOutput) => void): void;
    createAssetModelCompositeModel(args: CreateAssetModelCompositeModelCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateAssetModelCompositeModelCommandOutput) => void): void;
    /**
     ...
     */
    describeAssetCompositeModel(args: DescribeAssetCompositeModelCommandInput, options?: __HttpHandlerOptions): Promise<DescribeAssetCompositeModelCommandOutput>;
    describeAssetCompositeModel(args: DescribeAssetCompositeModelCommandInput, cb: (err: any, data?: DescribeAssetCompositeModelCommandOutput) => void): void;
    describeAssetCompositeModel(args: DescribeAssetCompositeModelCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeAssetCompositeModelCommandOutput) => void): void;
    /**
    ...
    executeAction(args: ExecuteActionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ExecuteActionCommandOutput) => void): void;
    /**
     ...
     */
    listAssetModelCompositeModels(args: ListAssetModelCompositeModelsCommandInput, options?: __HttpHandlerOptions): Promise<ListAssetModelCompositeModelsCommandOutput>;
    listAssetModelCompositeModels(args: ListAssetModelCompositeModelsCommandInput, cb: (err: any, data?: ListAssetModelCompositeModelsCommandOutput) => void): void;
    listAssetModelCompositeModels(args: ListAssetModelCompositeModelsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListAssetModelCompositeModelsCommandOutput) => void): void;
    /**
     ...
     */
    listCompositionRelationships(args: ListCompositionRelationshipsCommandInput, options?: __HttpHandlerOptions): Promise<ListCompositionRelationshipsCommandOutput>;
    listCompositionRelationships(args: ListCompositionRelationshipsCommandInput, cb: (err: any, data?: ListCompositionRelationshipsCommandOutput) => void): void;
    listCompositionRelationships(args: ListCompositionRelationshipsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListCompositionRelationshipsCommandOutput) => void): void;
    /**
     ...
     */
    updateAssetModelCompositeModel(args: UpdateAssetModelCompositeModelCommandInput, options?: __HttpHandlerOptions): Promise<UpdateAssetModelCompositeModelCommandOutput>;
    updateAssetModelCompositeModel(args: UpdateAssetModelCompositeModelCommandInput, cb: (err: any, data?: UpdateAssetModelCompositeModelCommandOutput) => void): void;
    updateAssetModelCompositeModel(args: UpdateAssetModelCompositeModelCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateAssetModelCompositeModelCommandOutput) => void): void;
    /**
