...
declare const UpdateAssetModelCompositeModelCommand_base: {
    new (input: UpdateAssetModelCompositeModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetModelCompositeModelCommandInput, UpdateAssetModelCompositeModelCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAssetModelCompositeModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetModelCompositeModelCommandInput, UpdateAssetModelCompositeModelCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
