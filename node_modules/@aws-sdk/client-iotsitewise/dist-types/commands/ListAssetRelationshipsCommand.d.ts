...
declare const ListAssetRelationshipsCommand_base: {
    new (input: ListAssetRelationshipsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetRelationshipsCommandInput, ListAssetRelationshipsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAssetRelationshipsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetRelationshipsCommandInput, ListAssetRelationshipsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
