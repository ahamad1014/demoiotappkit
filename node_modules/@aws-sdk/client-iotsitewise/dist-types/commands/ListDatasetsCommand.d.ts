...
declare const ListDatasetsCommand_base: {
    new (input: ListDatasetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDatasetsCommandInput, ListDatasetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListDatasetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDatasetsCommandInput, ListDatasetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
