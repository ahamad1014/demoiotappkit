...
declare const UpdateGatewayCapabilityConfigurationCommand_base: {
    new (input: UpdateGatewayCapabilityConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayCapabilityConfigurationCommandInput, UpdateGatewayCapabilityConfigurationCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateGatewayCapabilityConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayCapabilityConfigurationCommandInput, UpdateGatewayCapabilityConfigurationCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
