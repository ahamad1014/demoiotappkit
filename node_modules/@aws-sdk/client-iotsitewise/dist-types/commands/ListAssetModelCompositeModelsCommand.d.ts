...
declare const ListAssetModelCompositeModelsCommand_base: {
    new (input: ListAssetModelCompositeModelsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetModelCompositeModelsCommandInput, ListAssetModelCompositeModelsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAssetModelCompositeModelsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetModelCompositeModelsCommandInput, ListAssetModelCompositeModelsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
