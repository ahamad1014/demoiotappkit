...
declare const ListAssociatedAssetsCommand_base: {
    new (input: ListAssociatedAssetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssociatedAssetsCommandInput, ListAssociatedAssetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAssociatedAssetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssociatedAssetsCommandInput, ListAssociatedAssetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
