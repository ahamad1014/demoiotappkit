...
declare const ListProjectAssetsCommand_base: {
    new (input: ListProjectAssetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProjectAssetsCommandInput, ListProjectAssetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListProjectAssetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProjectAssetsCommandInput, ListProjectAssetsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
