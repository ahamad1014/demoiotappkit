...
declare const UpdateAssetModelCommand_base: {
    new (input: UpdateAssetModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetModelCommandInput, UpdateAssetModelCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAssetModelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetModelCommandInput, UpdateAssetModelCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
