...
declare const ListAssetPropertiesCommand_base: {
    new (input: ListAssetPropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetPropertiesCommandInput, ListAssetPropertiesCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAssetPropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAssetPropertiesCommandInput, ListAssetPropertiesCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
