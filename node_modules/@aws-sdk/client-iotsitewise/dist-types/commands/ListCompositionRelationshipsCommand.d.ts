...
declare const ListCompositionRelationshipsCommand_base: {
    new (input: ListCompositionRelationshipsCommandInput): import("@smithy/smithy-client").CommandImpl<ListCompositionRelationshipsCommandInput, ListCompositionRelationshipsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListCompositionRelationshipsCommandInput): import("@smithy/smithy-client").CommandImpl<ListCompositionRelationshipsCommandInput, ListCompositionRelationshipsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
