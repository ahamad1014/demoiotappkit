...
declare const UpdateAccessPolicyCommand_base: {
    new (input: UpdateAccessPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccessPolicyCommandInput, UpdateAccessPolicyCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAccessPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccessPolicyCommandInput, UpdateAccessPolicyCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
