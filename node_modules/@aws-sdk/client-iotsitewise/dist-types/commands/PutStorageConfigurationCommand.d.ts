...
declare const PutStorageConfigurationCommand_base: {
    new (input: PutStorageConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutStorageConfigurationCommandInput, PutStorageConfigurationCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutStorageConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutStorageConfigurationCommandInput, PutStorageConfigurationCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
