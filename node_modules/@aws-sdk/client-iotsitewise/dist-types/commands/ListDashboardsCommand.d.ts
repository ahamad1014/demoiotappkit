...
declare const ListDashboardsCommand_base: {
    new (input: ListDashboardsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDashboardsCommandInput, ListDashboardsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListDashboardsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDashboardsCommandInput, ListDashboardsCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
