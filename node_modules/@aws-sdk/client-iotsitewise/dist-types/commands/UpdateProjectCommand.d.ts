...
declare const UpdateProjectCommand_base: {
    new (input: UpdateProjectCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProjectCommandInput, UpdateProjectCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateProjectCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProjectCommandInput, UpdateProjectCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
