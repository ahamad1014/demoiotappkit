...
declare const UpdateAssetCommand_base: {
    new (input: UpdateAssetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetCommandInput, UpdateAssetCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAssetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAssetCommandInput, UpdateAssetCommandOutput, IoTSiteWiseClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
