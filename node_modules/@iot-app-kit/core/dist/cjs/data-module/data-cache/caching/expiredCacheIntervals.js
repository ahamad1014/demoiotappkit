...
exports.getExpiredCacheIntervals = void 0;
const intervalStructure_1 = require("../../../common/intervalStructure");
/**
...
const getExpiredCacheIntervals = (ttlDurationMapping, { start, end, requestedAt }) => {
    ...
    return (0, intervalStructure_1.intersect)(expiredIntervals, [[start.getTime(), end.getTime()]]);
};
exports.getExpiredCacheIntervals = getExpiredCacheIntervals;
