...
exports.addInterval = exports.mergeItems = exports.subtractIntervals = exports.intersect = exports.isContained = void 0;
const intervals_fn_1 = require("intervals-fn");
...
const isContained = (structure, interval) => structure.intervals.some(([start, end]) => start <= interval[0] && end >= interval[1]);
exports.isContained = isContained;
const intersect = (aIntervals, bIntervals) => {
    const intersectedIntervals = (0, intervals_fn_1.simplify)((0, intervals_fn_1.intersect)(aIntervals.map(toObjectNotation), bIntervals.map(toObjectNotation)));
...
const subtractIntervals = (interval, intervals) => {
    ...
    const subtractedIntervals = (0, intervals_fn_1.substract)([toObjectNotation(interval)], (0, intervals_fn_1.simplify)(sortedIntervals));
    return (0, intervals_fn_1.simplify)(subtractedIntervals)
...
const addInterval = (intervalStructure, interval, items, compare) => {
    ...
    const combinedItems = overlappingIntervals.reduce((mergedItems, { index }) => (0, exports.mergeItems)(mergedItems, intervalStructure.items[index], compare), items);
    // Get Insert Points
