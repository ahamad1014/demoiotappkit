import type { BatchGetAssetPropertyValueRequest, BatchGetAssetPropertyValueResponse, BatchGetAssetPropertyValueHistoryRequest, BatchGetAssetPropertyValueHistoryResponse, DescribeAssetRequest, DescribeAssetResponse, DescribeAssetModelRequest, DescribeAssetModelResponse, ExecuteQueryRequest, ExecuteQueryResponse, GetAssetPropertyValueRequest, GetAssetPropertyValueResponse, GetAssetPropertyValueHistoryRequest, GetAssetPropertyValueHistoryResponse, ListAssetModelsRequest, ListAssetModelsResponse, ListAssetModelPropertiesRequest, ListAssetModelPropertiesResponse, ListAssetsRequest, ListAssetsResponse, ListAssociatedAssetsRequest, ListAssociatedAssetsResponse, ListAssetPropertiesRequest, ListAssetPropertiesResponse, ListTimeSeriesRequest, ListTimeSeriesResponse } from '@aws-sdk/client-iotsitewise';
 ...
 */
export type GetAssetPropertyValue = RequestFunction<GetAssetPropertyValueRequest, GetAssetPropertyValueResponse>;
/**
 ...
 */
export type BatchGetAssetPropertyValue = RequestFunction<BatchGetAssetPropertyValueRequest, BatchGetAssetPropertyValueResponse>;
/**
 ...
 */
export type GetAssetPropertyValueHistory = RequestFunction<GetAssetPropertyValueHistoryRequest, GetAssetPropertyValueHistoryResponse>;
/**
 ...
 */
export type BatchGetAssetPropertyValueHistory = RequestFunction<BatchGetAssetPropertyValueHistoryRequest, BatchGetAssetPropertyValueHistoryResponse>;
/**
 ...
 */
export type ExecuteQuery = RequestFunction<ExecuteQueryRequest, ExecuteQueryResponse>;
/**
 ...
 */
export type ListAssetModels = RequestFunction<ListAssetModelsRequest, ListAssetModelsResponse>;
/**
 ...
 */
export type ListAssetModelProperties = RequestFunction<ListAssetModelPropertiesRequest, ListAssetModelPropertiesResponse>;
/**
 ...
 */
export type ListAssociatedAssets = RequestFunction<ListAssociatedAssetsRequest, ListAssociatedAssetsResponse>;
/**
 ...
 */
export type ListTimeSeries = RequestFunction<ListTimeSeriesRequest, ListTimeSeriesResponse>;
/**
 ...
 */
export type ListAssetProperties = RequestFunction<ListAssetPropertiesRequest, ListAssetPropertiesResponse>;
/**
 ...
 */
export type DescribeAsset = RequestFunction<DescribeAssetRequest, DescribeAssetResponse>;
/**
 ...
 */
export type DescribeAssetModel = RequestFunction<DescribeAssetModelRequest, DescribeAssetModelResponse>;
//# sourceMappingURL=iotsitewise.d.ts.map