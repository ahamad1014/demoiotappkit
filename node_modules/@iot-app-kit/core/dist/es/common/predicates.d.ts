...
import type { DurationViewport, HistoricalViewport, Viewport } from '../data-module/data-cache/requestTypes';
/**
 * Predicate Utilities
 *
...
export declare const isHistoricalViewport: (viewport: Viewport) => viewport is HistoricalViewport;
export declare const isDurationViewport: (viewport: Viewport) => viewport is DurationViewport;
