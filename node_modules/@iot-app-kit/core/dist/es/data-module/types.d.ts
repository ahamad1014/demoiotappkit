...
export type OnSuccessCallback = (dataStreams: DataStream[], requestInformation: RequestInformationAndRange, start: Date, end: Date) => void;
...
export type ErrorCallback = ({ id, resolution, aggregationType, error, }: {
    id: string;
    resolution: number;
    error: ErrorDetails;
    aggregationType?: AggregateType;
