...
const resolution = require('./resolution-4168502d.js');
  ...
  constructor(hostRef) {
    ...
    this.expandNode = (node) => {
      ...
      (_a = node.hierarchies) === null || _a === void 0 ? void 0 : _a.forEach((hierarchy) => {
        this.provider.expand(new resolution.BranchReference(node.id, hierarchy.id));
      });
    };
  }
  buildProvider() {
      ...
      newItems.forEach(({ id, hierarchies, hasChildren }) => {
        if (!this.expandedItems[id] && hasChildren) {
          hierarchies === null || hierarchies === void 0 ? void 0 : hierarchies.forEach((hierarchy) => {
            this.provider.expand(new resolution.BranchReference(id, hierarchy.id));
          });
...
exports.iot_resource_explorer = IotResourceExplorer;
