...
const domUtils = require('./dom-utils-ecb26edf.js');
const activeRouter = require('./active-router-4c962be2.js');
...
const IotTestRoutes = class {
  ...
  render() {
    return (index.h("stencil-router", null, index.h("stencil-route-switch", { scrollTopOffset: 0 }, routes.map((r) => (index.h("stencil-route", { key: r.url, url: r.url, component: r.component, exact: true }))))));
  }
};
...
exports.iot_test_routes = IotTestRoutes;
