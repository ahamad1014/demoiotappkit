...
const IotTreeTableDemo = class {
  constructor(hostRef) {
    ...
    this.filterPlaceholder = 'Filter by name';
  }
  render() {
    return (index.h("iot-tree-table", { items: this.items, collectionOptions: this.collectionOptions, columnDefinitions: this.columnDefinitions, selectionType: 'single', filterPlaceholder: this.filterPlaceholder, onExpandChildren: (node) => {
...
IotTreeTableDemo.style = awsuiCss;

exports.iot_tree_table_demo = IotTreeTableDemo;
