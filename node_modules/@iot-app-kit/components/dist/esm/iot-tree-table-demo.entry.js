...
const IotTreeTableDemo = class {
  ...
  render() {
    return (h("iot-tree-table", { items: this.items, collectionOptions: this.collectionOptions, columnDefinitions: this.columnDefinitions, selectionType: 'single', filterPlaceholder: this.filterPlaceholder, onExpandChildren: (node) => {
...
export { IotTreeTableDemo as iot_tree_table_demo };
